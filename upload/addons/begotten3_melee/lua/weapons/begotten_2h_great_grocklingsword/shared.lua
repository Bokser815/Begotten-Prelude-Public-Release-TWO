...
SWEP.PrintName = "Grockling Stone Sword"
...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "GrocklingStoneSwordAttackTable"
SWEP.BlockTable = "GrocklingStoneSwordBlockTable"
...
SWEP.VElements = {
	["viewmodelsword"] = { type = "Model", model = "models/demonssouls/weapons/dragon_bone_smasher.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.284, -0.237, -1.759), angle = Angle(83.273, -104.433, 76.16), size = Vector(0.768, 0.768, 0.768), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}


SWEP.WElements = {
	["worldmodelsword"] = { type = "Model", model = "models/demonssouls/weapons/dragon_bone_smasher.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.099, 1.182, 1.758), angle = Angle(270, 0, 120), size = Vector(0.846, 0.846, 0.846), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	--["worldmodelsword"] = { type = "Model", model = "models/demonssouls/weapons/dragon_bone_smasher.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(3.099, 1.182, 1.758), angle = Angle(99.663, 109.847, 86.612), size = Vector(0.846, 0.846, 0.846), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
