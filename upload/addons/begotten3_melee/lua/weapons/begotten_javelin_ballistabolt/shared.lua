...
SWEP.AttackTable = "BallistaAttackTable"

SWEP.Primary.Round = ("begotten_javelin_ballista_thrown");
...
function SWEP:FireJavelin()
	...
	if SERVER then
		...
		javelin:SetModel("models/begotten/ballistabolt.mdl");
	...
	if SERVER and owner:IsPlayer() then
		...
		if owner.opponent then
			...
			if owner.StripWeapon then
				owner:StripWeapon("begotten_javelin_ballistabolt");
			end
		else
...
SWEP.VElements = {
	["v_ballista"] = { type = "Model", model = "models/begotten/ballistabolt.mdl", bone = "v_weapon.Knife_Handle", rel = "", pos = Vector(2.4, 0.15, -6.753), angle = Angle(105, 0, 82.986), size = Vector(0.75, 0.75, 0.75), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_ballista"] = { type = "Model", model = "models/begotten/ballistabolt.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.89, 0.2, -10.91), angle = Angle(97.013, 40.909, 54.935), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElementsAlternate = {
	["w_ballista"] = { type = "Model", model = "models/begotten/ballistabolt.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1, -0.9), angle = Angle(-97, -110, 0), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}