...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "MeatCleaverAttackTable"
SWEP.BlockTable = "MeatCleaverBlockTable"
...
SWEP.VElements = {
	["v_meatcleaver"] = { type = "Model", model = "models/bf1/weapons/meat cleaver.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.99, 1.2, -0.7), angle = Angle(-1, -2, 179), size = Vector(1.05, 1.05, 1.05), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_meatcleaver"] = { type = "Model", model = "models/bf1/weapons/meat cleaver.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.3, 0.9, 0.1), angle = Angle(-179.9, 140, 5), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}