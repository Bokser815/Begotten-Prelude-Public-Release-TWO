...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "PoleHookAttackTable"
SWEP.BlockTable = "PoleHookBlockTable"
...
SWEP.VElements = {
	["v_phook"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/polehook.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.99, 2, 7.714), angle = Angle(0, -90, 180), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {[0] = 1} }
}

SWEP.WElements = {
	["w_phook"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/polehook.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1.75, 5.4), angle = Angle(-174.157, 73.636, 1.169), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {[0] = 1} }
}