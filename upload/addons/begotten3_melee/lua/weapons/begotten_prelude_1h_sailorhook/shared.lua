...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "SailorHookAttackTable"
SWEP.BlockTable = "SailorHookBlockTable"
...
SWEP.VElements = {
	["v_shook"] = { type = "Model", model = "models/bf1/weapons/marine hook.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.5, 1.7, 0.3), angle = Angle(-8.183, 74.026, 180), size = Vector(1.1, 1.1, 1.1), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_shook"] = { type = "Model", model = "models/bf1/weapons/marine hook.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1.75, 1.4), angle = Angle(-174.157, 73.636, 1.169), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}