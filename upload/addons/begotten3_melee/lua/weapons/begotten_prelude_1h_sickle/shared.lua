...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "SickleAttackTable"
SWEP.BlockTable = "SickleBlockTable"
...
SWEP.VElements = {
	["v_sickle"] = { type = "Model", model = "models/bf1/weapons/sickle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.99, 1.5, 0), angle = Angle(0, 2, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 3, bodygroup = {[0] = 5, [1] = 1} }
}

SWEP.WElements = {
	["w_sickle"] = { type = "Model", model = "models/bf1/weapons/sickle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.2, 1.1, 0), angle = Angle(-179, 169, 10), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 3, bodygroup = {[0] = 5, [1] = 1} }
}