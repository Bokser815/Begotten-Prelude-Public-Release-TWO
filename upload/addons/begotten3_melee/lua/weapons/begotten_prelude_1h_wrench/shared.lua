...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "PipeWrenchAttackTable"
SWEP.BlockTable = "PipeWrenchBlockTable"
...
SWEP.VElements = {
	["v_pwrench"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/pipewrench.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.99, 0.899, 5.714), angle = Angle(-8.183, 104.026, 180), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_pwrench"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/pipewrench.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1.75, 5.4), angle = Angle(-174.157, 73.636, 1.169), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}