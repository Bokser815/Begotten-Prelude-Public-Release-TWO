...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "EstocAttackTable"
SWEP.BlockTable = "EstocBlockTable"
...
SWEP.VElements = {
	["v_longsword"] = { type = "Model", model = "models/begotten/weapons/estoc.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0, 0.5, 2.557), angle = Angle(82.986, 0, 57.272), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_longsword"] = { type = "Model", model = "models/begotten/weapons/estoc.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.5, 1, 1.596), angle = Angle(-97.014, 73.636, -162.469), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}