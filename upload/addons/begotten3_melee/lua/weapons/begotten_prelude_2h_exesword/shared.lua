...
SWEP.PrintName = "Executioner's Sword"
...
--For 2h viewmodel
SWEP.CriticalPlaybackRate = 0.5
SWEP.PrimaryPlaybackRate = 0.5
...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "ExecutionerAttackTable"
SWEP.BlockTable = "ExecutionerBlockTable"
...
SWEP.VElements = {
	["v_longsword"] = { type = "Model", model = "models/begotten/weapons/executionersword.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0, 0.5, 2.557), angle = Angle(90.986, 180, 57.272), size = Vector(0.9, 0.9, 0.9), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_longsword"] = { type = "Model", model = "models/begotten/weapons/executionersword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.5, 2, 1.5), angle = Angle(-100.014, 113.636, -162.469), size = Vector(0.9, 0.9, 0.9), material = "", skin = 0, bodygroup = {} }
}