...
SWEP.VElements = {
	["v_warclub"] = { type = "Model", model = "models/weapons/peasantstar/bludgeoner.mdl", bone = "RW_Weapon", rel = "", pos = Vector(-1, 0.15, -6), angle = Angle(-81.9, 122.726, -101.689), size = Vector(0.879, 0.879, 0.879), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_warclub"] = { type = "Model", model = "models/weapons/peasantstar/bludgeoner.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(3.196, 0.557, 5.557), angle = Angle(-99.35, 75.053, -50.259), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}