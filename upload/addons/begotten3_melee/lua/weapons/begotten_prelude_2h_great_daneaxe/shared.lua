...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "DaneAxeAttackTable"
SWEP.BlockTable = "DaneAxeBlockTable"
...
SWEP.VElements = {
	["v_bardiche"] = { type = "Model", model = "models/weapons/daneaxe/daneaxe.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(-3.491, 10.909, 1.399), angle = Angle(0, -90, 20), size = Vector(0.91, 0.91, 0.91), material = "", skin = 0, bodygroup = {[0] = 3} }
}

SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/weapons/daneaxe/daneaxe.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(3.457, 1.48, 0), angle = Angle(-101.112, 85.555, 1.11), size = Vector(0.966, 0.966, 0.966), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}