...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "HeavyCleaverAttackTable"
SWEP.BlockTable = "HeavyCleaverBlockTable"
...
SWEP.VElements = {
	["v_gorecleaver"] = { type = "Model", model = "models/begotten/weapons/bill.mdl", bone = "RW_Weapon", rel = "", pos = Vector(-0.731, -0, -16.105), angle = Angle(1.5, 85, 1.5), size = Vector(0.899, 0.899, 0.899), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_gorecleaver"] = { type = "Model", model = "models/begotten/weapons/bill.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(3.9, 1.557, 0.518), angle = Angle(176.494, -5.844, -174.157), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}