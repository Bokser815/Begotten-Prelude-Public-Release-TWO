...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "KanaboAttackTable"
SWEP.BlockTable = "KanaboBlockTable"
...
SWEP.VElements = {
	["v_warclub"] = { type = "Model", model = "models/begotten/weapons/kanabo.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0, 0.15, -1), angle = Angle(98.9, 122.726, -101.689), size = Vector(0.709, 0.709, 0.709), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_warclub"] = { type = "Model", model = "models/begotten/weapons/kanabo.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(2.596, 1.557, 1.557), angle = Angle(99.35, -118.053, 50.259), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}