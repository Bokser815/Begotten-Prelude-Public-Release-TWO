...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "ScrapHackerAttackTable"
SWEP.BlockTable = "ScrapHackerBlockTable"
...
SWEP.VElements = {
	["v_longsword"] = { type = "Model", model = "models/begotten/weapons/scrappersword.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0, 0.5, 2.557), angle = Angle(90.986, 180, 57.272), size = Vector(0.9, 0.9, 0.9), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_longsword"] = { type = "Model", model = "models/begotten/weapons/scrappersword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.457, 1.48, 0), angle = Angle(-94.445, -134.445, -3.333), size = Vector(0.87, 0.87, 0.87), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}