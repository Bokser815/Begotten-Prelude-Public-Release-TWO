...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "ScrapHalberdAttackTable"
SWEP.BlockTable = "ScrapHalberdBlockTable"
...
SWEP.VElements = {
	["v_halberd"] = { type = "Model", model = "models/slop/scraphalberd.mdl", bone = "v_weapon.Knife_Handle", rel = "", pos = Vector(1, -0.519, -0.519), angle = Angle(-20, 230, 10), size = Vector(0.8, 0.8, 0.8), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_halberd"] = { type = "Model", model = "models/slop/scraphalberd.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4.099, -0.201, -10.91), angle = Angle(10.494, 90.844, 174.157), size = Vector(0.899, 0.899, 0.899), material = "", skin = 0, bodygroup = {} }
}
