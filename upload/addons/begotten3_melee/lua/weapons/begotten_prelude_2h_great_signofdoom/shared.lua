...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "SignOfDoomAttackTable"
SWEP.BlockTable = "SignOfDoomBlockTable"
...
SWEP.VElements = {
	["v_gorecleaver"] = { type = "Model", model = "models/slop/signofdoom.mdl", bone = "RW_Weapon", rel = "", pos = Vector(-0.731, -0, -5.105), angle = Angle(1.5, 175, 1.5), size = Vector(0.899, 0.899, 0.899), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_gorecleaver"] = { type = "Model", model = "models/slop/signofdoom.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(3.3, 1.557, 5.518), angle = Angle(176.494, 90.844, -174.157), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}