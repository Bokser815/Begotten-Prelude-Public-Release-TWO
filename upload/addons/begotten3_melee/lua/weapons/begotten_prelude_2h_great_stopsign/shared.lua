...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "StopSignAttackTable"
SWEP.BlockTable = "StopSignBlockTable"
...
SWEP.VElements = {
	["v_stopsign"] = { type = "Model", model = "models/stophere.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(-4.2, 15, 2), angle = Angle(270, 15, -70), size = Vector(.7, .7, .7), material = "", skin = 0, bodygroup = {[0] = 3} }
}

SWEP.WElements = {
	["w_stopsign"] = { type = "Model", model = "models/stophere.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(4.2, 2, -15), angle = Angle(0, 40, -5), size = Vector(0.899, 0.899, 0.899), material = "", skin = 0, bodygroup = {[0] = 3} }
}