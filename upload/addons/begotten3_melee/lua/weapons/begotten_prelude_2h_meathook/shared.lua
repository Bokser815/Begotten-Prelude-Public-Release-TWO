...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "MeatHookAttackTable"
SWEP.BlockTable = "MeatHookBlockTable"
...
SWEP.VElements = {
	["v_meathook"] = { type = "Model", model = "models/props_junk/meathook001a.mdl", bone = "RightHand_1stP", rel = "", pos = Vector(-6.4, -4, 2), angle = Angle(270, 18, 90), size = Vector(0.91, 0.91, 0.91), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 3} }
}

SWEP.WElements = {
	["w_meathook"] = { type = "Model", model = "models/props_junk/meathook001a.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(6.2, 0.1, 8), angle = Angle(170, 90, 0), size = Vector(0.899, 0.899, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 3} }
}