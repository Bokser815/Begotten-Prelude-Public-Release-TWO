...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "ScrapChopperAttackTable"
SWEP.BlockTable = "ScrapChopperBlockTable"
...
SWEP.VElements = {
	["v_longsword"] = { type = "Model", model = "models/weapons/chopper/chopper.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.493, 0.493, 17.284), angle = Angle(-90.223, -225.556, 58.888), size = Vector(0.903, 0.903, 0.903), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/weapons/chopper/chopper.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.457, 1.48, -12.346), angle = Angle(90.55, -276.667, -7.778), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}