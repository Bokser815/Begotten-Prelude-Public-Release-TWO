...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "TippedStaffAttackTable"
SWEP.BlockTable = "TippedStaffBlockTable" 
...
SWEP.VElements = {
	["v_spear_wingedspear"] = { type = "Model", model = "models/weapons/tippedstaff/tippedstaff.mdl", bone = "v_weapon.Knife_Handle", rel = "", pos = Vector(-1.199, 0.919, 8.832), angle = Angle(108.7, 0, -29.222), size = Vector(0.699, 0.699, 0.699), material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["w_spear_wingedspear"] = { type = "Model", model = "models/weapons/tippedstaff/tippedstaff.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.796, -1.157, -17.557), angle = Angle(-78.312, 57.272, 11.558), size = Vector(0.899, 0.899, 0.899), material = "", skin = 0, bodygroup = {} }
}