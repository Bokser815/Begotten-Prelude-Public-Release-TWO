...
SWEP.PrintName = "Sparring Gloves"
...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "BoxerAttackTable"
SWEP.BlockTable = "BoxerBlockTable"
...
---------------------------------------------------------*/
SWEP.VElements = {
	["v_boxer_left"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/BoxingGlove_Left.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(-1.5, 0.7, -.3), angle = Angle(-5, -100, -90), size = Vector(1.1, 1.1, 1.1), material = "", skin = 0, bodygroup = {} },
	["v_boxer_right"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/boxingglove.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-1.5, 0, 0), angle = Angle(150, 90, 75), size = Vector(1.1, 1.1, 1.1), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_boxer_right"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/boxingglove.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-1.5, 0.69, 0), angle = Angle(0, -102, -90), size = Vector(1.15, 1.15, 1.15), material = "", skin = 0, bodygroup = {} },
	["w_boxer_left"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/BoxingGlove_Left.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(-1.5, 0.69, -0.5), angle = Angle(0, -102, -85), size = Vector(1.15, 1.15, 1.15), material = "", skin = 0, bodygroup = {} }
}