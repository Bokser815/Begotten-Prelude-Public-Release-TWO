...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "VoltFistAttackTable"
SWEP.BlockTable = "VoltFistBlockTable"
...
---------------------------------------------------------*/
SWEP.VElements = {
	["v_voltfist_left"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/powerfist.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(-6.1, -0.25, -2), angle = Angle(5, -95, -70.676), size = Vector(1.1, 1.1, 0.8), material = "", skin = 0, bodygroup = {} },
	["v_voltfist_right"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/powerfist.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-6.1, 0.2, -0), angle = Angle(20, -90, -90.338), size = Vector(1.1, 1.1, 0.8), material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_voltfist_right"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/powerfist.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-7.2, 1, 0), angle = Angle(0, -90, -90), size = Vector(1, 1, 0.8), material = "", skin = 0, bodygroup = {} },
	["w_voltfist_left"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/powerfist.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(-7.2, 3.6, 0), angle = Angle(0, -77, -90), size = Vector(1, 1, 0.8), material = "", skin = 0, bodygroup = {} }
}