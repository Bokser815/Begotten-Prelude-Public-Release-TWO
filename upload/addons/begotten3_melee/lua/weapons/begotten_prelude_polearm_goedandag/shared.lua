...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "GoedendagAttackTable"
SWEP.BlockTable = "GoedendagBlockTable"
...
SWEP.VElements = {
	["v_spear_wingedspear"] = { type = "Model", model = "models/begotten/weapons/goedendag.mdl", bone = "v_weapon.Knife_Handle", rel = "", pos = Vector(3.799, -0.519, -8.832), angle = Angle(108.7, 0, -29.222), size = Vector(0.699, 0.699, 0.699), material = "", skin = 0, bodygroup = {} },
}

SWEP.WElements = {
	["w_spear_wingedspear"] = { type = "Model", model = "models/begotten/weapons/goedendag.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.596, 1.557, -4.557), angle = Angle(-78.312, 57.272, 31.558), size = Vector(1, 1, 1), material = "", skin = 0, bodygroup = {} }
}
