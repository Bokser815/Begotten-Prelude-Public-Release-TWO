...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "HewingSpearAttackTable"
SWEP.BlockTable = "HewingSpearBlockTable"
...
SWEP.VElements = {
	["v_spear_wingedspear"] = { type = "Model", model = "models/weapons/hewingspear/hewingspear.mdl", bone = "v_weapon.Knife_Handle", rel = "", pos = Vector(0.799, 0.519, 0.832), angle = Angle(288.7, 0, -29.222), size = Vector(0.799, 0.799, 0.799), material = "", skin = 0, bodygroup = {} },
}
SWEP.WElements = {
	["w_spear_wingedspear"] = { type = "Model", model = "models/weapons/hewingspear/hewingspear.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.596, 0, -10.557), angle = Angle(98.312, 50, 10.558), size = Vector(0.899, 0.899, 0.899), material = "", skin = 0, bodygroup = {} }
}