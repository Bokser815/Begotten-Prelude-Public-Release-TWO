...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "VoltRapierAttackTable"
SWEP.BlockTable = "VoltRapierAttackTable"
...
SWEP.VElements = {
	["v_voltrapier"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/revolutionarysword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.635, 1, 0.657), angle = Angle(-3.507, -102.663, -180), size = Vector(1, 1, 1.1), material = "", skin = 1, bodygroup = {[0] = 3} }
}

SWEP.WElements = {
	["w_voltrapier"] = { type = "Model", model = "models/mosi/fallout4/props/weapons/melee/revolutionarysword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.596, 1, -0.494), angle = Angle(180, 70, 8), size = Vector(1, 1, 1.1), material = "", skin = 1, bodygroup = {[0] = 3} }
}