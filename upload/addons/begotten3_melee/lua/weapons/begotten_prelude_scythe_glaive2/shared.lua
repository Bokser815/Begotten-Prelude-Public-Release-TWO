...
/*---------------------------------------------------------
	PrimaryAttack
---------------------------------------------------------*/
SWEP.AttackTable = "Glaive2AttackTable"
SWEP.BlockTable = "Glaive2BlockTable"
...
SWEP.VElements = {
	["v_stupidweapon_glaive"] = { type = "Model", model = "models/weapons/glaive/glaive.mdl", bone = "RW_Weapon", rel = "", pos = Vector(-0.4, -0.393, -5.181), angle = Angle(-78.889, 87.777, 90), size = Vector(0.777, 0.777, 0.777), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["w_stupidweapon_glaive"] = { type = "Model", model = "models/weapons/glaive/glaive.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.457, 0.493, 6.42), angle = Angle(78.888, 85.555, 1.11), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}