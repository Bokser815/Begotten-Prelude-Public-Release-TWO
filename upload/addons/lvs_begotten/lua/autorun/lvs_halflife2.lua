local function Initialize()
    ...
    CreateConVar("lvs_car_hl2_combineapc_rocketspeed", 1000, nil, "Controls the speed of the Missle from the Combine APC.")
...
hook.Add("PrePlayerDraw", "LVS.HalfLife2", function(ply)
    ...
    if ( vehicle:GetClass():lower() == "lvs_wheeldrive_hl2_combine_apc" or vehicle:GetClass():lower() == "lvs_wheeldrive_hl2_combine_apc_armed" ) then
        ...
        if ( localPlayer:lvsGetVehicle() == vehicle ) then
            return
        end
