...
ENT.MDL = "Models/sentry/apc_fo4.mdl"

list.Set("Vehicles", ENT.PrintName, ENT);
...
ENT.MaxVelocity = 700 -- max velocity in forward direction in gmod-units/second
...
ENT.EngineSounds = {
	{
		sound = "vehicles/sgmcars/humvee_fo3/idle.wav",
		Volume = 2,
		Pitch = 100,
		PitchMul = 25,
		SoundLevel = 75,
	...
	{
		sound = "vehicles/sgmcars/humvee_fo3/first.wav",
		--sound_int = "path/to/interior/sound.wav",
		Volume = 2, -- adjust volume
		Pitch = 25, -- start pitch value
    ...
    {
        sound = "vehicles/sgmcars/humvee_fo3/throttle_off.wav",
		--sound_int = "path/to/interior/sound.wav",
		Volume = 2, -- adjust volume
...
function ENT:InitWeapons()
	...
	weapon.Attack = function( ent )
		local ID = ent:LookupAttachment( "main_muzzle" )
