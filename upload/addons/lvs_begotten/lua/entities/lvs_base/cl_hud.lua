...
LVS:AddHudEditor( "VehicleHealth", 10, ScrH() - 85,  220, 75, 220, 75, "VEHICLE HEALTH", 
	function( self, vehicle, X, Y, W, H, ScrX, ScrY, ply )
		...
		vehicle:LVSHudPaintVehicleFuel( X, Y, W, H, ScrX, ScrY, ply )
	end
)
...
function ENT:LVSHudPaintVehicleHealth( X, Y, W, H, ScrX, ScrY, ply )
	draw.DrawText( "HEALTH ", "BarTextBegotten", X + 108, Y + 35, Color(179, 46, 49, 255), TEXT_ALIGN_RIGHT )
	draw.DrawText( math.Round( self:GetHP(), 0 ), "BarTextBegotten", X + 108, Y + 35, Color(179, 46, 49, 255), TEXT_ALIGN_LEFT )
end

function ENT:LVSHudPaintVehicleFuel( X, Y, W, H, ScrX, ScrY, ply )
	draw.DrawText( "Fuel ", "BarTextBegotten", X + 250, Y + 35, Color(179, 46, 49, 255), TEXT_ALIGN_RIGHT )
	draw.DrawText( math.Round( self:GetFuel(), 0 ), "BarTextBegotten", X + 250, Y + 35, Color(179, 46, 49, 255), TEXT_ALIGN_LEFT )
end
...
local Circles = {
	...
	[2] = {r = 0, col = Color(179, 46, 49, 255)},
	[3] = {r = 1, col = Color(179, 46, 49, 255)},
	[4] = {r = 2, col = Color(179, 46, 49, 255)},
