...
local Circles = {
	...
	[2] = {r = 0, col = Color(179, 46, 49,200)},
	[3] = {r = 1, col = Color(179, 46, 49,255)},
	[4] = {r = 2, col = Color(179, 46, 49,200)},
...
function ENT:LVSHudPaintWeaponInfo( X, Y, w, h, ScrX, ScrY, ply )
	...
	draw.DrawText( "AMMO ", "BarTextBegotten", X + 72, Y + 35, Color(179, 46, 49, 255), TEXT_ALIGN_RIGHT )
	draw.DrawText( Base:GetNWAmmo(), "BarTextBegotten", X + 72, Y + 35, Color(179, 46, 49, 255), TEXT_ALIGN_LEFT )
end
...
function ENT:LVSHudPaintWeapons( X, Y, w, h, ScrX, ScrY, ply )
	...
	local ColSelect = Color(179, 46, 49,A150)
	...
	for ID = 1, num do
		...
		if IsSelected then
			...
			surface.SetDrawColor( 179, 46, 49, A255 )
		end

		if isbool( EntTable.WEAPONS[PodID][ID].Icon ) then
			local col = IsSelected and Color(179, 46, 49,A255) or Color(0,0,0,A255) 
		...
		if ammo > -1 then
			draw.DrawText( ammo, "LVS_FONT_HUD", xPos + w - 10, yPos + SizeY * 0.5 - 10, IsSelected and Color(0,0,0,A255) or Color(179, 46, 49,A255), TEXT_ALIGN_RIGHT )
		else
			draw.DrawText( "O", "LVS_FONT_HUD", xPos + w - 19, yPos + SizeY * 0.5 - 10, IsSelected and Color(0,0,0,A255) or Color(179, 46, 49,A255), TEXT_ALIGN_RIGHT )
			draw.DrawText( "O", "LVS_FONT_HUD", xPos + w - 10, yPos + SizeY * 0.5 - 10, IsSelected and Color(0,0,0,A255) or Color(179, 46, 49,A255), TEXT_ALIGN_RIGHT )
		end
	end
end