...
ENT.Lights = {
    {
        Trigger = "high",
        Sprites = {
            {pos = Vector(-18.06,-23.53,67.58), colorB = 200, colorA = 150},
            {pos = Vector(18.06,-23.53,67.58), colorB = 200, colorA = 150},
        },
        ProjectedTextures = {
            {pos = Vector(-18.06,-23.53,67.58), ang =Angle(0,90,0), colorB = 200, colorA = 150, shadows = false, farz = 2000},
            {pos = Vector(18.06,-23.53,67.58), ang =Angle(0,90,0), colorB = 200, colorA = 150, shadows = false, farz = 2000},
        },
    },
    {
        ...
        ProjectedTextures = {
            {pos = Vector(-18.06,-23.53,67.58), ang =Angle(10,90,0), colorB = 200, colorA = 150, shadows = false, farz = 1000},
            {pos = Vector(18.06,-23.53,67.58), ang =Angle(10,90,0), colorB = 200, colorA = 150, shadows = false, farz = 1000},
        },
    },
    {
        Trigger = "main+brake", 
        Sprites = {
            {pos = Vector(-13.02,-60.5,62.96), colorB = 200, colorA = 150},
            {pos = Vector(13.02,-60.5,62.96), colorB = 200, colorA = 150},
        },
    },
    {
