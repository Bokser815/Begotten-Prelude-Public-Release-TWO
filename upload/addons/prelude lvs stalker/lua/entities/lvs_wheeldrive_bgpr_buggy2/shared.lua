...
ENT.Lights = {
    {
        Trigger = "high",
        Sprites = {
            {pos = Vector(-28.32,58.59,41.93), colorB = 200, colorA = 150},
            {pos = Vector(28.32,58.59,41.93), colorB = 200, colorA = 150},
        },
        ProjectedTextures = {
            {pos = Vector(-28.32,58.59,41.93), ang =Angle(0,90,0), colorB = 200, colorA = 150, shadows = false, farz = 2000},
            {pos = Vector(28.32,58.59,41.93), ang =Angle(0,90,0), colorB = 200, colorA = 150, shadows = false, farz = 2000},
        },
    },
    {
        ...
        ProjectedTextures = {
            {pos = Vector(-28.32,58.59,41.93), ang =Angle(10,90,0), colorB = 200, colorA = 150, shadows = false, farz = 1000},
            {pos = Vector(28.32,58.59,41.93), ang =Angle(10,90,0), colorB = 200, colorA = 150, shadows = false, farz = 1000},
        },
    },
    {
