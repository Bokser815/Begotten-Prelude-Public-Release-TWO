...
function Clockwork.animation:AddDarklanderEastArms(model)
	self:AddHandsModel(model, {
		body = 0000000,
		model = "models/begotten/arms/c_mordhaueast.mdl",
		skin = 0
	});
end;

function Clockwork.animation:AddDarklanderRusArms(model)
	self:AddHandsModel(model, {
		body = 0000000,
		model = "models/begotten/arms/c_mordhaurus.mdl",
		skin = 0
	});
end;
function Clockwork.animation:AddDarklanderNazirArms(model)
	self:AddHandsModel(model, {
		body = 0000000,
		model = "models/begotten/arms/c_nazir.mdl",
		skin = 0
	});
end;

function Clockwork.animation:AddKvetchiArms(model)
	self:AddHandsModel(model, {
		body = 0000000,
		model = "models/begotten/arms/c_kvetchimerc.mdl",
		skin = 0
	});
end;

function Clockwork.animation:AddColovianArms(model)
	self:AddHandsModel(model, {
		body = 0000000,
		model = "models/begotten/arms/c_colovianprince.mdl",
		skin = 0
	});
end;

function Clockwork.animation:AddMageSetArms(model)
	self:AddHandsModel(model, {
		body = 0000000,
		model = "models/begotten/arms/c_mageset.mdl",
		skin = 0
	});
end;

function Clockwork.animation:AddKhuzaitSoldierArms(model)
	self:AddHandsModel(model, {
		body = 0000000,
		model = "models/begotten/arms/c_khuzaitsoldier.mdl",
		skin = 0
	});
end;

function Clockwork.animation:AddKhuzaitLordArms(model)
	self:AddHandsModel(model, {
		body = 0000000,
		model = "models/begotten/arms/c_khuzaitlord.mdl",
		skin = 0
	});
end;

function Clockwork.animation:AddGoreDragonTamerArms(model)
	self:AddHandsModel(model, {
		body = 0000000,
		model = "models/begotten/arms/c_shagalaxchief.mdl",
		skin = 0
	});
end;

function Clockwork.animation:AddIconoclastArms(model)
	self:AddHandsModel(model, {
		body = 0000000,
		model = "models/begotten/arms/c_iconoclast.mdl",
		skin = 0
	});
end;
...
function Clockwork.animation:AddWandererJerkinArms(model)
	self:AddHandsModel(model, {
		body = 0000000,
		model = "models/begottenprelude/arms/wandererjerkin.mdl",
		skin = 0
	});
end;

function Clockwork.animation:AddWandererCoatOfPlatesArms(model)
	self:AddHandsModel(model, {
		body = 0000000,
...
Clockwork.animation:AddDarklanderRusArms("models/begotten/prelude_darklanders/mordhaurus");
Clockwork.animation:AddDarklanderEastArms("models/begotten/prelude_darklanders/mordhaueast");
Clockwork.animation:AddDarklanderNazirArms("models/begotten/prelude_darklanders/nazir");
Clockwork.animation:AddKvetchiArms("models/begottenprelude/darklanders/kvetchimerc.mdl");
Clockwork.animation:AddColovianArms("models/begottenprelude/darklanders/colovianprince.mdl");
Clockwork.animation:AddMageSetArms("models/begottenprelude/darklanders/mageset.mdl");

Clockwork.animation:AddKhuzaitSoldierArms("models/begotten/prelude_deadlanders/khuzaitsoldier");
Clockwork.animation:AddKhuzaitLordArms("models/begotten/prelude_deadlanders/khuzaitlord");

Clockwork.animation:AddGoreDragonTamerArms("models/begotten/goreicwarfighters/shagalaxchief");

Clockwork.animation:AddIconoclastArms("models/begotten/wanderers/iconoclast");
...
Clockwork.animation:AddWandererJerkinArms("models/begotten/prelude_wanderers/wandererjerkin");

Clockwork.animation:AddWandererCoatOfPlatesArms("models/begotten/prelude_wanderers/coatofplates");
