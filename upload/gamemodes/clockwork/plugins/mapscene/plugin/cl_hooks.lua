...
if map == "bg_prelude" then
	camTable = {
		["Wanderer"] = {
			camVector = Vector(-13297,12467,4658),
			camAngles = Angle(3,-180,0),
			closeCamVector = Vector(-13315,12467,4658),
			charVector = Vector(-13342,12467,4599),
		...
		["The Third Inquisition"] = {
			camVector = Vector(2815,14290,4744),
			camAngles = Angle(0, 0, 0),
			closeCamVector = Vector(2841,14289,4744),
			charVector = Vector(2867,14290,4685),
			charAngles = Angle(0,179,0),
			charModel = {clothes = "models/begotten/wanderers/wanderer_male.mdl", head = "models/begotten/heads/male_04_wanderer.mdl"},
			charBodygroup = {1, 2},
			zone = "wasteland"
		},		
		["Piston's Scrappers"] = {
			camVector = Vector(-12302,10970,115),
			camAngles = Angle(-9,-139,0),
			--closeCamVector = Vector(-12314,10957,110),
			closeCamVector = Vector(-12316,10957,112),
			charVector = Vector(-12341,10935,61),
			charAngles = Angle(0,43,0),
			charModel = {clothes = "models/begoyten/awesome/blackhand_male.mdl", head = "models/begoyten/heads/male_bhand_wanderer.mdl"},
			charBodygroup = {1, 2},
			zone = "wasteland"
		},
		["Gatekeeper"] = {
			--camVector = Vector(2815,14287,4744),
			camVector = Vector(2815,14290,4744),
			camAngles = Angle(0, 0, 0),
			closeCamVector = Vector(2841,14289,4744),
			charVector = Vector(2867,14290,4685),
		...
		["Children of Satan"] = {
			camVector = Vector(8401,-14367,-13661),
		...
		["Darklanders"] = {
			camVector = Vector(8471,-14387,-13661),
			camAngles = Angle(-4,0,0),
			closeCamVector = Vector(8497,-14387,-13661),
			--charVector = Vector(8527,-14370,-13715),
			charVector = Vector(8527,-14387,-13715),
			charAngles = Angle(0, 180, 0),
			charModel = "models/begottenprelude/darklanders/kvetchimerc.mdl",
			charModelOverride = {clothes = "models/begotten/wanderers/wanderer_male.mdl", head = "models/begotten/heads/male_13_wanderer.mdl"},
			zone = "hell"
		},
		["Qarin Bloodsworn"] = {
		...
		["Order of Eternal Penance"] = {
			camVector = Vector(2815,14290,4744),
			camAngles = Angle(0, 0, 0),
			closeCamVector = Vector(2841,14289,4744),
			charVector = Vector(2867,14290,4685),
			charAngles = Angle(0,179,0),
			charModel = {clothes = "models/begotten/prelude_wanderers/templar_male.mdl", head = "models/begotten/heads/male_02_glaze.mdl"},
			zone = "tower"
		},
	};
	...
	subfactionCamTable = {
		["Yihnari"] = {
			charModel = {clothes = "models/begotten/prelude_darklanders/mordhaurus_male.mdl", head = "models/begotten/heads/male_02_glaze.mdl"},
			camVector = Vector(8471,-14398,-13661),
			camAngles = Angle(-4,0,0),
		},
		["Nehemian"] = {
			charModel = {clothes = "models/begotten/prelude_darklanders/nazir_male.mdl", head = "models/begotten/heads/male_02_glaze.mdl"},
			camVector = Vector(8471,-14398,-13661),
			camAngles = Angle(-4,0,0),
		},
		["Aswaran"] = {
			charModel = "models/begottenprelude/darklanders/immortal.mdl",
			camVector = Vector(8471,-14398,-13661),
			camAngles = Angle(-4,0,0),
		},	
		["Immortal"] = {
		...
		["Legionary"] = {
			charModel = {clothes = "models/begotten/gatekeepers/gatekeepermedium_male.mdl", head = "models/begotten/heads/male_02_glaze.mdl"},
			charBodygroup = {1, 4},
			camVector = Vector(2800,14280,4744),
			camAngles = Angle(0, 0, 0),
		},
		["Auxiliary"] = {
		...
		["Shepherds"] = {
			charModel = {clothes = "models/begotten/gatekeepers/roundhead_red_male.mdl", head = "models/begotten/heads/male_07_glaze.mdl"},
			charBodygroup = {1, 1},
			camVector = Vector(2800,14280,4744),
			camAngles = Angle(0, 0, 0),
		},
		...
		["Shepherds of Light"] = {
			charModel = {clothes = "models/begotten/gatekeepers/minister_male.mdl", head = "models/begotten/heads/male_07_glaze.mdl"},
			camVector = Vector(2800,14280,4744),
			camAngles = Angle(0, 0, 0),
		},
		["Cavalier"] = {
			charModel = "models/begottenprelude/wanderers/scrapperbossarmor.mdl",
			camVector = Vector(-12315,10970,115),
			camAngles = Angle(-9,-139,0),
		},
		["Fuelsaint"] = {
			charModel = "models/begottenprelude/wanderers/scrapperskink_male.mdl",
			camVector = Vector(-12315,10970,115),
			camAngles = Angle(-9,-139,0),
		},
		["Blackhand"] = {
			charModel = "models/begottenprelude/wanderers/scrapperspiked_male.mdl",
			camVector = Vector(-12315,10970,115),
			camAngles = Angle(-9,-139,0),
		},
		["Scut"] = {
		...
		["Pilgrim"] = {
			charModel = {clothes = "models/begotten/wanderers/wanderer_male.mdl", head = "models/begotten/heads/male_04_wanderer.mdl"},
			camVector = Vector(-13297,12477,4658),
			camAngles = Angle(3,-180,0),
		},
		["Darklander"] = {
			charModel = {clothes = "models/begotten/wanderers/wanderer_male.mdl", head = "models/begotten/heads/male_04_wanderer.mdl"},
...
elseif map == "rp_begotten3" then
	...
	subfactionCamTable = {
		...
		["Legionary"] = {
			charModel = {clothes = "models/begotten/gatekeepers/gatekeepermedium_male.mdl", head = "models/begotten/heads/male_02_glaze.mdl"},
			charBodygroup = {1, 4},
			camVector = Vector(2799,14284,4744),
			camAngles = Angle(0, 0, 0),
		},
		["Auxiliary"] = {
			charModel = {clothes = "models/begotten/gatekeepers/gatekeeperlight_black_male.mdl", head = "models/begotten/heads/male_04_glaze.mdl"},
...
elseif map == "rp_district21" then
	...
	subfactionCamTable = {
		...
		["Legionary"] = {
			charModel = {clothes = "models/begotten/gatekeepers/gatekeepermedium_male.mdl", head = "models/begotten/heads/male_02_glaze.mdl"},
			charBodygroup = {1, 4},
			camVector = Vector(12912, -1389, -747),
			camAngles = Angle(2.5, -39.5, 0),
		},
		["Auxiliary"] = {
			charModel = {clothes = "models/begotten/gatekeepers/gatekeeperlight_black_male.mdl", head = "models/begotten/heads/male_04_glaze.mdl"},
