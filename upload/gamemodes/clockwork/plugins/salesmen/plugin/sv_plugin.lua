...
function cwSalesmen:LoadSalesmen()
	...
	for k, v in pairs(salesmen) do
		...
		salesman.cwWeapon = v.weapon or "begotten_1h_ironarmingsword";
		salesman.cwTextTab.warn = salesman.cwTextTab.warn or {
			text = "Agh!",
			bHideName = false,
			sound = nil,
		...
		salesman.cwTextTab.hostile = salesman.cwTextTab.hostile or {
