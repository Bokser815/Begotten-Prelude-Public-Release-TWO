...
local APTITUDE = cwBeliefs.beliefTrees:New("aptitude")
	...
	APTITUDE.textures = {"aptitudealt", "aptitudearrows"};
	APTITUDE.tooltip = {
	...
	APTITUDE.beliefs = {
		[1] = {
			["precise_measurements"] = {
				...
				description = "It is now impossible for a concoction to randomly explode during the mixing process. This does not prevent explosive reactions.",
				requirements = {"literacy", "alchemist"},
				row = 3,
			},
			["fungal_intuition"] = {
				name = "Fungal Intuition",
				description = "Prevents the creation of Grey Mush when attempting to craft an invalid compound. Also prevents missing an ingredient's aroma when smelling a concoction.",
		...
		[2] = {
			...
			["wasteless"] = {
				name = "Wasteless",
				description = "Unlocks the 'Disassembly' mechanic.",
				requirements = {"literacy", "alchemist"},
				row = 3,
			},
			["chrysopoeia"] = {
				name = "Chrysopoeia",
				description = "Unlocks the 'Transmutation' mechanic.",
				requirements = {"literacy", "alchemist", "wasteless"},
				row = 4,
			},
		},
		[3] = {
		...
		[4] = {
			...
			["doctor"] = {
				name = "Doctor",
				description = "Unlocks the ability to diagnose a patient's injuries. Doubles the speed of healing other characters as well as the speed of applying chloroform. Also unlocks the ability to see when people are injured.",
