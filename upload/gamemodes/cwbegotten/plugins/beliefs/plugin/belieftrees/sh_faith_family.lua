	...
	FAMILY.beliefs = {
		...
		[3] = {
			["old_son"] = {
				...
				description = "Selects the 'Faith of the Old Son' as your subfaith. Unlocks the ability to pray. Unlocks the ability to warcry. Increased residual faith gain. Increased faith gain from woodcutting.",
