	...
	LIGHT.beliefs = {
		...
		[3] = {
			...
			["purity_afloat"] = {
				name = "Purity Afloat",
				subfaith = "Sol Orthodoxy",
				description = "Increases movement speed by a maximum of 20% (at 25% health) the lower your health is. The movement speed increase of Heavy Armor is capped at +15%.", -- order of eternal penance todo sprite whatever
