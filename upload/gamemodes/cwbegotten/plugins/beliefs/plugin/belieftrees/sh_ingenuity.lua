...
local INGENUITY = cwBeliefs.beliefTrees:New("ingenuity")
	...
	INGENUITY.textures = {"ingenuityalt", "ingenuityarrows"};
	INGENUITY.tooltip = {
		{"Ingenuity", INGENUITY.color, "Civ5ToolTip4"},
		{"Ingenuity is a measure of your character's craftiness, primarily affecting your character's effectiveness at Crafting. Upgrading this belief set will progressively unlock more crafting options. More Crafting options may become available if this belief set is paired with aptitude. As your sacrament level increases, your crafted items will have increased condition.", Color(225, 200, 200)},
