...
local ITEM = Clockwork.item:New();
	ITEM.name = "Scrap Chunks";
	ITEM.category = "Crafting Materials";
	ITEM.model = "models/mosi/fallout4/props/junk/components/ceramic.mdl";
	ITEM.weight = 2;
	ITEM.uniqueID = "scrap_bricks";
	ITEM.description = "Clumps of pressed scrap that now serve as a valuable foundation for crafting.";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/ceramic.png";
	ITEM.stackable = true;
...
local ITEM = Clockwork.item:New();
	ITEM.name = "Tire";
	ITEM.category = "Crafting Materials";
	ITEM.model = "models/diggercars/stalker/moskv_wheel.mdl";
	ITEM.weight = 1.5;
	ITEM.uniqueID = "road_tire";
	ITEM.description = "A tire used to construct vehicles or other contraptions.";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/moskv_wheel.png";
	ITEM.stackable = true;
...
local ITEM = Clockwork.item:New();
	ITEM.name = "Set of Tires";
	ITEM.category = "Crafting Materials";
	ITEM.model = "models/props_junk/wood_crate001a.mdl";
	ITEM.weight = 6;
	ITEM.uniqueID = "road_tire_set";
	ITEM.description = "A set of tires used to construct vehicles.";
	--ITEM.iconoverride = "materials/begotten/ui/itemicons/moskv_wheel.png";
	ITEM.stackable = true;
...
local ITEM = Clockwork.item:New();
	ITEM.name = "Scrapped Engine";
	ITEM.category = "Crafting Materials";
	ITEM.model = "models/props_c17/trappropeller_engine.mdl";
	ITEM.weight = 3;
	ITEM.uniqueID = "scrap_engine_block";
	ITEM.description = "A beat up shitty engine used to construct vehicles or other contraptions.";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/trappropeller_engine.png";
	ITEM.stackable = true;
...
local ITEM = Clockwork.item:New();
	ITEM.name = "Restored Engine";
	ITEM.category = "Crafting Materials";
	ITEM.model = "models/vehicle/vehicle_engine_block.mdl";
	ITEM.weight = 4;
	ITEM.uniqueID = "restored_engine_block";
	ITEM.description = "A high quality engine block used to construct vehicles or other contraptions.";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/vehicle_engine_block.png";
	ITEM.stackable = true;
...
local ITEM = Clockwork.item:New();
	ITEM.name = "(Transmuted) Iron Ingot";
	ITEM.category = "Crafting Materials";
	ITEM.model = "models/props_clutter/ingot_iron.mdl";
	ITEM.weight = 0.3;
	ITEM.uniqueID = "transmutated_iron_ingot";
	ITEM.description = "A low-quality ingot of iron that can be further smithed into a weapon or into a set of armor.";
	--ITEM.iconoverride = "materials/begotten/ui/itemicons/crude_iron_ingot.png";
	ITEM.stackable = true;
...
local ITEM = Clockwork.item:New();
	ITEM.name = "(Transmuted) Steel Ingot";
	ITEM.category = "Crafting Materials";
	ITEM.model = "models/props_clutter/ingot_steel.mdl";
	ITEM.weight = 0.3;
	ITEM.uniqueID = "transmutated_steel_ingot";
	ITEM.description = "An ingot of steel that can be further smithed into a weapon or into a set of armor.";
	--ITEM.iconoverride = "materials/begotten/ui/itemicons/"..ITEM.uniqueID..".png";
	ITEM.stackable = true;
...
local ITEM = Clockwork.item:New();
	ITEM.name = "(Transmuted) Fine Steel Ingot";
	ITEM.category = "Crafting Materials";
	ITEM.model = "models/props_clutter/ingot_silver.mdl";
	ITEM.weight = 0.3;
	ITEM.uniqueID = "transmutated_fine_steel_ingot";
	ITEM.description = "An ingot of refined, stronger steel that can be further smithed into a weapon or into a set of armor.";
	--ITEM.iconoverride = "materials/begotten/ui/itemicons/"..ITEM.uniqueID..".png";
	ITEM.stackable = true;
...
local ITEM = Clockwork.item:New();
	...
	ITEM.category = "Crafting Materials";
	ITEM.model = "models/props_clutter/ingot_ebony.mdl";
	ITEM.weight = 0.3;
...
local ITEM = Clockwork.item:New();
	ITEM.name = "(Transmuted) Hellforged Steel Ingot";
	ITEM.category = "Crafting Materials";
	ITEM.model = "models/props_clutter/ingot_ebony.mdl";
	ITEM.weight = 0.3;
	ITEM.uniqueID = "transmutated_hellforged_steel_ingot";
	ITEM.description = "An ingot of black steel forged in the furnaces of Hell itself. It has supernatural durability and strength.";
	--ITEM.iconoverride = "materials/begotten/ui/itemicons/fine_steel_ingot.png";
	ITEM.stackable = true;
...
local ITEM = Clockwork.item:New();
	...
	ITEM.category = "Crafting Materials";
	ITEM.model = "models/props_clutter/madness_ingot.mdl";
	ITEM.weight = 0.3;
...
local ITEM = Clockwork.item:New();
	ITEM.name = "(Transmuted) Maximilian Steel Ingot";
	ITEM.category = "Crafting Materials";
	ITEM.model = "models/props_clutter/madness_ingot.mdl";
	ITEM.weight = 0.3;
	ITEM.uniqueID = "transmutated_maximilian_steel_ingot";
	ITEM.description = "Considered by those of the Faith of the Light to be a holy representation of Lord Maximus' might due to its strength and purity, the legendary Maximilian steel is the purest form of steel imaginable. Forged in an ancient era, it has many reputed mystical properties.";
	--ITEM.iconoverride = "materials/begotten/ui/itemicons/fine_steel_ingot.png";
	ITEM.stackable = true;
...
local ITEM = Clockwork.item:New();
	...
	ITEM.category = "Crafting Materials";
	ITEM.model = "models/props_clutter/ingot_orichalcum.mdl";
	ITEM.weight = 0.3;
...
local ITEM = Clockwork.item:New();
	ITEM.name = "(Transmuted) Shagalaxian Steel Ingot";
	ITEM.category = "Crafting Materials";
	ITEM.model = "models/props_clutter/ingot_orichalcum.mdl";
	ITEM.weight = 0.3;
	ITEM.uniqueID = "transmutated_shagalaxian_steel_ingot";
	ITEM.description = "Forged by the master blacksmiths of Clan Shagalax, Shagalaxian steel is of legendary quality and the strongest material available to the Gores. It has many reputed mystical properties.";
	--ITEM.iconoverride = "materials/begotten/ui/itemicons/fine_steel_ingot.png";
	ITEM.stackable = true;
...
local ITEM = Clockwork.item:New();
	ITEM.name = "(Transmuted) Gold Ingot";
	ITEM.category = "Crafting Materials";
	ITEM.model = "models/mosi/fallout4/props/junk/components/gold.mdl";
	ITEM.weight = 1;
	ITEM.uniqueID = "transmutated_gold_ingot";
	ITEM.description = "An ingot of Gold, once considered to be of enormous value. While it may still be worth a great deal of coin if turned in to the Hierarchy, it may be more valuable for the smithing of ornate weapons and armor.";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/"..ITEM.uniqueID..".png";
	ITEM.stackable = true;
