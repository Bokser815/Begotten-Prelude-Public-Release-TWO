...
function cwRecipes:ClockworkInitialized()
	...
	RECIPE = cwRecipes.recipes:New("scrap_chunks");
		RECIPE.name = "Scrap Chunks";
		RECIPE.requiresSmithy = true;
		RECIPE.requiredBeliefs = {"smith"};
		RECIPE.requiredFactions = {"Piston's Scrappers"};
		RECIPE.requirements = {
			["scrap"] = {amount = 9},
		};
		RECIPE.result = {
			["scrap_bricks"] = {amount = 1},
		};
		RECIPE.category = "Other"
	...
	RECIPE = cwRecipes.recipes:New("restored_engine");
		RECIPE.name = "Restored Engine";
		RECIPE.requiresSmithy = true;
		RECIPE.requiredBeliefs = {"smith"};
		RECIPE.requiredFactions = {"Piston's Scrappers"};
		RECIPE.requirements = {
			["scrap_engine_block"] = {amount = 1},
			["scrap_bricks"] = {amount = 3},
		};
		RECIPE.result = {
			["restored_engine_block"] = {amount = 1},
		};
		RECIPE.category = "Other"
		RECIPE.finishSound = "generic_ui/smelt_success_02.wav";
		RECIPE.failSound = "buttons/button2.wav"
	...
	RECIPE = cwRecipes.recipes:New("tire_set");
		RECIPE.name = "Set of Tires";
		RECIPE.requiresSmithy = true;
		RECIPE.requiredBeliefs = {"smith"};
		RECIPE.requiredFactions = {"Piston's Scrappers"};
		RECIPE.requirements = {
	...
	RECIPE = cwRecipes.recipes:New("steel_ingot");
		...
		RECIPE.requirements = {
			["iron_ingot"] = {amount = 2, substitute = "transmutated_iron_ingot"},
			["charcoal"] = {amount = 1},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("fine_steel_ingot");
		...
		RECIPE.requirements = {
			["steel_ingot"] = {amount = 2, substitute = "transmutated_steel_ingot"},
			["charcoal"] = {amount = 1},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("hellforged_steel_ingot");
		...
		RECIPE.requirements = {
			["fine_steel_ingot"] = {amount = 2, substitute = "transmutated_fine_steel_ingot"},
	...
	RECIPE = cwRecipes.recipes:New("maximilian_steel_ingot");
		...
		RECIPE.requiredFaiths = {"Faith of the Light"};
		RECIPE.requirements = {
			["fine_steel_ingot"] = {amount = 3, substitute = "transmutated_fine_steel_ingot"},
			["charcoal"] = {amount = 2},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("shagalaxian_steel_ingot");
		...
		RECIPE.requirements = {
			["fine_steel_ingot"] = {amount = 2, substitute = "transmutated_fine_steel_ingot"},
			["steel_ingot"] = {amount = 1, substitute = "transmutated_steel_ingot"},
			["charcoal"] = {amount = 2},
		};
		RECIPE.result = {
	...
	RECIPE:Register()
		...
		-- Reag craftings from farming
		RECIPE = cwRecipes.recipes:New("fungus_soup");
		RECIPE.name = "Fungus Soup";
		RECIPE.requiresHeatSource = true;
		RECIPE.requiredBeliefs = {"cookist"};
		RECIPE.requiredBeliefsNiceNames = {"Cookist"};
		RECIPE.requirements = {
		...
		RECIPE.result = {
			["fungus_soup"] = {amount = 1}, -- better bread in the future..
		};
		RECIPE.category = "Cooking"
		RECIPE.finishSound = "ambient/fire/mtov_flame2.wav";
		RECIPE.failSound = "buttons/button2.wav"
	...
	RECIPE:Register()
	-- Bread recipe
	RECIPE = cwRecipes.recipes:New("cooked_bread");
		RECIPE.name = "Bread";
		RECIPE.requiresHeatSource = true;
		RECIPE.requiredBeliefs = {"cookist"};
		RECIPE.requiredBeliefsNiceNames = {"Cookist"};
		...
		RECIPE.result = {
			["moldy_bread"] = {amount = 1}, -- better bread in the future..
		};
		RECIPE.category = "Cooking"
		RECIPE.finishSound = "ambient/fire/mtov_flame2.wav";
		RECIPE.failSound = "buttons/button2.wav"
	...
	RECIPE:Register()
	-- Cigar recipe
	RECIPE = cwRecipes.recipes:New("cigar");
		RECIPE.name = "Cigar";
		RECIPE.requiresHeatSource = true;
		RECIPE.requiredBeliefs = {"craftsman"};
		...
		RECIPE.result = {
			["cigar"] = {amount = 1}, -- no cigar item yet, need to pull from apoc
		};
		RECIPE.category = "Other"
		RECIPE.finishSound = "ambient/fire/mtov_flame2.wav"
		RECIPE.failSound = "buttons/button2.wav"
		RECIPE.craftTime = 8
		RECIPE.craftVerb = "rolling"
		RECIPE.experience = 15;
	...
	RECIPE:Register()
	-- Ointment recipe
	RECIPE = cwRecipes.recipes:New("ointment");
		RECIPE.name = "Ointment";
		RECIPE.requiresHeatSource = true;
		RECIPE.requiredBeliefs = {"craftsman"};
		RECIPE.requiredBeliefsNiceNames = {"Craftsman"};
		RECIPE.requirements = {
	...
	RECIPE:Register()
	-- Cloth recipe
	RECIPE = cwRecipes.recipes:New("cloth");
		RECIPE.name = "Cloth";
		RECIPE.requiresHeatSource = true;
		RECIPE.requiredBeliefs = {"craftsman"};
		RECIPE.requiredBeliefsNiceNames = {"Craftsman"};
	...
	RECIPE:Register()
	-- Med planter recipe
	RECIPE = cwRecipes.recipes:New("medium_planter");
		RECIPE.name = "Medium Planter";
		RECIPE.requiresHeatSource = false;
		RECIPE.requiredBeliefs = {"craftsman"};
		RECIPE.requiredBeliefsNiceNames = {"Craftsman"};
		RECIPE.requirements = {
			["wood"] = {amount = 5}, -- rebalance later perhaps
			["scrap"] = {amount = 1},
			["fertilizer"] = {amount = 3},
		};
		RECIPE.result = {
			["medium_planter"] = {amount = 1},
		};
		RECIPE.category = "Other"
		RECIPE.finishSound = "generic_ui/smelt_success_02.wav";
		RECIPE.failSound = "buttons/button2.wav"
	...
	RECIPE = cwRecipes.recipes:New("firearm_repair_kit");
		...
		RECIPE.requirements = {
			["iron_ingot"] = {amount = 1},
			["scrap"] = {amount = 2, scrapperAmount = 1},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("elegant_dagger");
		...
		RECIPE.excludedFactions = {"Goreic Warrior"};
		RECIPE.requirements = {
			["fine_steel_ingot"] = {amount = 1, subtitute = "transmutated_fine_steel_ingot"},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("claymore");
		...
		RECIPE.excludedFactions = {"Goreic Warrior"};
		RECIPE.requirements = {
			["steel_ingot"] = {amount = 4, subtitute = "transmutated_steel_ingot"},
			["fine_steel_ingot"] = {amount = 1, substitute = "transmutated_fine_steel_ingot"},
			["wood"] = {amount = 2},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("gore_cleaver");
		...
		RECIPE.requiredFactions = {"Goreic Warrior"};
		RECIPE.requirements = {
			["iron_ingot"] = {amount = 3, substitute = "transmutated_iron_ingot"},
			["wood"] = {amount = 3},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("grocklingstonesword");
		...
		RECIPE.requiredBeliefs = {"sagegrock"};
		RECIPE.requiredBeliefsNiceNames = {"Sagely Wisdom"};
		RECIPE.requiredFactions = {"Goreic Warrior"};
		RECIPE.requirements = {
			["stone"] = {amount = 4},
			["gold_ore"] = {amount = 1},
	...
	RECIPE = cwRecipes.recipes:New("evening_star");
		...
		RECIPE.requirements = {
			["steel_ingot"] = {amount = 2, substitute = "transmutated_steel_ingot"},
			["iron_ingot"] = {amount = 1, substitute = "transmutated_iron_ingot"},
			["wood"] = {amount = 3},
			["leather"] = {amount = 1},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("scraphammer");
		...
		RECIPE.excludedFactions = {"Goreic Warrior"};
		RECIPE.requirements = {
			["scrap"] = {amount = 5, scrapperAmount = 4},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("volthammer");
		...
		RECIPE.requirements = {
			["begotten_2h_great_scraphammer"] = {amount = 1},
			["tech"] = {amount = 3, scrapperAmount = 2},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("voltprod");
		...
		RECIPE.requiredSubfaiths = {"Voltism"};
		RECIPE.requirements = {
			["scrap"] = {amount = 4, scrapperAmount = 3},
			["tech"] = {amount = 4, scrapperAmount = 3},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("flanged_mace");
		...
		RECIPE.excludedFactions = {"Goreic Warrior"};
		RECIPE.requirements = {
			["steel_ingot"] = {amount = 4, substitute = "transmutated_steel_ingot"},
		};
		RECIPE.result = {
	...
	RECIPE.requirements = {
		["fine_steel_ingot"] = {amount = 2, substitute = "transmutated_fine_steel_ingot"},
		["gold_ingot"] = {amount = 1, substitute = "transmutated_gold_ingot"},
	};
	RECIPE.result = {
...
RECIPE:Register()
	...
	RECIPE = cwRecipes.recipes:New("steel_arming_sword");
		...
		RECIPE.excludedFactions = {"Goreic Warrior"};
		RECIPE.requirements = {
			["steel_ingot"] = {amount = 3, substitute = "transmutated_steel_ingot"},
			["leather"] = {amount = 1},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("spatha");
		...
		RECIPE.requiredFactions = {"Gatekeeper", "Holy Hierarchy", "Hillkeeper"};
		RECIPE.requirements = {
			["iron_ingot"] = {amount = 4, substitute = "transmutated_iron_ingot"},
			["wood"] = {amount = 1},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("lungemine");
		RECIPE.name = "Lunge Mine";
		RECIPE.requiresSmithy = true;
		RECIPE.requiredBeliefs = {"young_son"};
		RECIPE.requirements = {
			["steel_ingot"] = {amount = 1, substitute = "transmutated_steel_ingot"},
			["wood"] = {amount = 3},
			["gunpowder"] = {amount = 3},
		...
		RECIPE.result = {
			["begotten_polearm_lungemine"] = {amount = 1},
		};
		RECIPE.category = "Weapons"
		RECIPE.finishSound = "generic_ui/smelt_success_02.wav";
		RECIPE.failSound = "buttons/button2.wav"
	...
	RECIPE = cwRecipes.recipes:New("polehammer");
		...
		RECIPE.excludedFactions = {"Goreic Warrior"};
		RECIPE.requirements = {
			["steel_ingot"] = {amount = 5, substitute = "transmutated_steel_ingot"},
			["wood"] = {amount = 4},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("elegant_epee");
		...
		RECIPE.excludedFactions = {"Goreic Warrior"};
		RECIPE.requirements = {
			["fine_steel_ingot"] = {amount = 2, substitute = "fine_steel_ingot"},
			["gold_ingot"] = {amount = 1},
			["wood"] = {amount = 1},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("shard");
		...
		RECIPE.excludedFactions = {"Goreic Warrior"};
		RECIPE.requirements = {
			["hellforged_steel_ingot"] = {amount = 1, substitute = "transmutated_hellforged_steel_ingot"},
			["steel_ingot"] = {amount = 1},
			["down_catalyst"] = {amount = 1},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("unholy_sigil_sword");
		...
		RECIPE.excludedFactions = {"Goreic Warrior"};
		RECIPE.requirements = {
			["iron_ingot"] = {amount = 5, substitute = "transmutated_iron_ingot"},
	...
	RECIPE = cwRecipes.recipes:New("dreadaxe");
		...
		RECIPE.excludedFactions = {"Goreic Warrior"};
		RECIPE.requirements = {
			["hellforged_steel_ingot"] = {amount = 4, substitute = "transmutated_hellforged_steel_ingot"},
			["unholy_sigil_stone"] = {amount = 1},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("bell_hammer");
		...
		RECIPE.requiredFaiths = {"Faith of the Light"};
		RECIPE.requirements = {
			["iron_ingot"] = {amount = 8, substitute = "transmutated_iron_ingot"},
	...
	RECIPE = cwRecipes.recipes:New("demonslayer_greataxe");
		...
		RECIPE.requiredFaiths = {"Faith of the Family"};
		RECIPE.requirements = {
			["shagalaxian_steel_ingot"] = {amount = 4, substitute = "transmutated_shagalaxian_steel_ingot"},
	...
	RECIPE = cwRecipes.recipes:New("frozenfatherlandaxe");
		...
		RECIPE.requiredFaiths = {"Faith of the Family"};
		RECIPE.requirements = {
			["shagalaxian_steel_ingot"] = {amount = 3, substitute = "transmutated_shagalaxian_steel_ingot"},
			["wood"] = {amount = 3},
	...
	RECIPE = cwRecipes.recipes:New("enchanted_longsword");
		...
		RECIPE.excludedFactions = {"Goreic Warrior"};
		RECIPE.requirements = {
			["maximilian_steel_ingot"] = {amount = 3, substitute = "transmutated_maximilian_steel_ingot"},
			["ice_sigil_stone"] = {amount = 1},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("glazicsword_glazicshield");
		...
		RECIPE.requirements = {
			["gold_ingot"] = {amount = 1, substitute = "transmutated_gold_ingot"},
			["maximilian_steel_ingot"] = {amount = 1, substitute = "transmutated_maximilian_steel_ingot"},
			["fire_sigil_stone"] = {amount = 1},
			["glazic_sigil_stone"] = {amount = 1},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("dreadshield");
		...
		RECIPE.requiredFaiths = {"Faith of the Dark"};
		RECIPE.requirements = {
			["steel_ingot"] = {amount = 7, substitute = "transmutated_steel_ingot"},
			["pentagram_catalyst"] = {amount = 1},
	...
	RECIPE = cwRecipes.recipes:New("steel_gatekeeper_shield");
		...
		RECIPE.requirements = {
			["shield11"] = {amount = 1},
			["steel_ingot"] = {amount = 8, substitute = "transmutated_steel_ingot"},
		};
		RECIPE.result = {
			["shield18"] = {amount = 1},
		};
	...
	RECIPE = cwRecipes.recipes:New("sol_sentinel_shield");
		...
		RECIPE.requiredFactions = {"Gatekeeper", "Holy Hierarchy"};
		RECIPE.requirements = {
			["maximilian_steel_ingot"] = {amount = 2, substitute = "transmutated_maximilian_steel_ingot"},
			["iron_ingot"] = {amount = 7, substitute = "transmutated_iron_ingot"},
		};
		RECIPE.result = {
			["shield9"] = {amount = 1},
		};
	...
	RECIPE = cwRecipes.recipes:New("scrap_shield");
		...
		RECIPE.excludedSubfactions = {"Clan Gore", "Clan Harald", "Clan Reaver", "Clan Crast", "Clan Grock"};
		RECIPE.requirements = {
			["scrap"] = {amount = 5, scrapperAmount = 3},
		};
		RECIPE.result = {
			["shield1"] = {amount = 1},
		};
	...
	RECIPE = cwRecipes.recipes:New("warfighter_shield");
		...
		RECIPE.requiredFaiths = {"Faith of the Family"};
		RECIPE.requirements = {
			["shagalaxian_steel_ingot"] = {amount = 1, substitute = "transmutated_shagalaxian_steel_ingot"},
			["iron_ingot"] = {amount = 4, substitute = "transmutated_iron_ingot"},
		};
		RECIPE.result = {
			["shield12"] = {amount = 1},
	...
	RECIPE = cwRecipes.recipes:New("red_wolf_shield");
		...
		RECIPE.requiredFaiths = {"Faith of the Family"};
		RECIPE.requirements = {
			["hellforged_steel_ingot"] = {amount = 2, substitute = "transmutated_hellforged_steel_ingot"},
			["iron_ingot"] = {amount = 5, substitute = "transmutated_iron_ingot"},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("slaveshield");
	RECIPE.name = "Slaveshield";
	RECIPE.requiredBeliefs = {"ingenious"};
...
RECIPE:Register()
	...
	RECIPE = cwRecipes.recipes:New("peppershot");
		...
		RECIPE.excludedSubfactions = {"Clan Gore", "Clan Harald", "Clan Reaver", "Clan Crast", "Clan Grock"};
		RECIPE.requirements = {
			["scrap"] = {amount = 3, scrapperAmount = 2},
			["iron_ingot"] = {amount = 1, substitute = "transmutated_iron_ingot"},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("scavenger_revolver");
	RECIPE.name = "Scavenger Revolver";
	RECIPE.requiresSmithy = true;
	RECIPE.requiredBeliefs = {"mechanic"};
	...
	RECIPE.result = {
		["begotten_scavenger_revolver"] = {amount = 1},
	};
	RECIPE.category = "Munitions"
	RECIPE.finishSound = "generic_ui/smelt_success_02.wav";
	RECIPE.failSound = "buttons/button2.wav"
...
RECIPE:Register()
	...
	RECIPE = cwRecipes.recipes:New("gore_shagalax_helm");
		...
		RECIPE.requirements = {
			["shagalaxian_steel_ingot"] = {amount = 2, substitute = "transmutated_shagalaxian_steel_ingot"},
			["steel_ingot"] = {amount = 3, substitute = "transmutated_steel_ingot"},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("voltist_archangel_exoskeleton");
		...
		RECIPE.requirements = {
			["technocraft"] = {amount = 1},
			["scrap"] = {amount = 8, scrapperAmount = 6},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("voltist_stormchaser_exoskeleton");
		...
		RECIPE.requiredSubfaiths = {"Voltism"};
		RECIPE.requirements = {
			["technocraft"] = {amount = 2, scrapperAmount = 1},
			["fine_steel_ingot"] = {amount = 2, substitute = "transmutated_fine_steel_ingot"},
			["steel_ingot"] = {amount = 2, substitute = "transmutated_steel_ingot"},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("wanderer_mail");
		...
		RECIPE.requirements = {
			["leather"] = {amount = 2},
			["iron_ingot"] = {amount = 6, substitute = "transmutated_iron_ingot"},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("scrapper_grunt_plate");
		...
		RECIPE.excludedSubfactions = {"Clan Gore", "Clan Harald", "Clan Reaver", "Clan Crast", "Clan Grock"};
		RECIPE.requirements = {
			["scrap"] = {amount = 6, scrapperAmount = 4},
			["cloth"] = {amount = 1},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("gatekeeper_helmet");
		...
		RECIPE.requiredFactions = {"Gatekeeper", "Holy Hierarchy"};
		RECIPE.requirements = {
			["iron_ingot"] = {amount = 2, substitute = "transmutated_steel_ingot"},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("scrap_helmet");
		...
		RECIPE.excludedSubfactions = {"Clan Gore", "Clan Harald", "Clan Reaver", "Clan Crast", "Clan Grock"};
		RECIPE.requirements = {
			["scrap"] = {amount = 4, scrapperAmount = 2},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("skullshield");
		...
		RECIPE.requiredFactions = {"Children of Satan"};
		RECIPE.requirements = {
			["fune_steel_ingot"] = {amount = 1, substitute = "transmutated_fine_steel_ingot"},
			["steel_ingot"] = {amount = 1, substitute = "transmutated_steel_ingot"},
			["cloth"] = {amount = 1},
		};
		RECIPE.result = {
	...
	RECIPE = cwRecipes.recipes:New("shit_assembly");
		RECIPE.name = "Shitwagon Assembly";
		RECIPE.requiredBeliefs = {"mechanic"};
		RECIPE.requiredBeliefsNiceNames = {"Mechanic"};
		RECIPE.requiredFactions = {"Piston's Scrappers"};
		RECIPE.requirements = {
			["road_tire_set"] = {amount = 1},
			["scrap_engine_block"] = {amount = 1},
			["scrap_bricks"] = {amount = 4},
		};
		RECIPE.result = {
			["shitwagon_assemble"] = {amount = 1},
		};
		RECIPE.category = "Other"
		RECIPE.finishSound = "generic_ui/wood_01.wav";
		RECIPE.failSound = "buttons/button2.wav"
		RECIPE.craftTime = 15
		RECIPE.craftVerb = "assembling"
		RECIPE.experience = 65;
	...
	RECIPE = cwRecipes.recipes:New("barricade");
		RECIPE.name = "Barricade";
		RECIPE.requiredBeliefs = {"mechanic"};
		RECIPE.requiredBeliefsNiceNames = {"Mechanic"};
		RECIPE.requirements = {
			["steel_ingot"] = {amount = 1, substitute = "transmutated_steel_ingot"},
	...
	RECIPE = cwRecipes.recipes:New("smallspikes");
		RECIPE.name = "Small Cavalry Spikes";
		RECIPE.requiredBeliefs = {"mechanic"};
		RECIPE.requiredBeliefsNiceNames = {"Mechanic"};
		RECIPE.requirements = {
			["wood"] = {amount = 4},
		...
		RECIPE.result = {
			["deployable_smallspikes"] = {amount = 1},
		};
		RECIPE.category = "Other"
		RECIPE.finishSound = "generic_ui/wood_01.wav";
		RECIPE.failSound = "buttons/button2.wav"
	...
	RECIPE = cwRecipes.recipes:New("bigspikes");
		RECIPE.name = "Large Cavalry Spikes";
		RECIPE.requiredBeliefs = {"mechanic"};
		RECIPE.requiredBeliefsNiceNames = {"Mechanic"};
		RECIPE.requirements = {
			["wood"] = {amount = 7},
	...
	RECIPE = cwRecipes.recipes:New("wanderer_tabard");
		RECIPE.name = "Wanderer Tabard";
		RECIPE.requiresSmithy = true;
		RECIPE.requiredBeliefs = {"mechanic"};
		RECIPE.requiredBeliefsNiceNames = {"Mechanic"};
		RECIPE.excludedFactions = {"Goreic Warrior"};
		RECIPE.requirements = {
			["leather"] = {amount = 2},
			["cloth"] = {amount = 2},
			["iron_ingot"] = {amount = 5, substitute = "transmutated_iron_ingot"}, -- since we buffed this bad boy, basically an alternative/sidegrade to light brigandine
		};
		RECIPE.result = {
			["wanderer_tabard"] = {amount = 1},
		};
		RECIPE.category = "Armor"
		RECIPE.finishSound = "generic_ui/refine_success_02.wav";
		RECIPE.failSound = "buttons/button2.wav"
	...
	RECIPE = cwRecipes.recipes:New("wanderer_gambeson");
		RECIPE.name = "Wanderer Gambeson";
		RECIPE.requiredBeliefs = {"craftsman"};
		RECIPE.requiredBeliefsNiceNames = {"Craftsman"};
		RECIPE.excludedFactions = {"Goreic Warrior"};
		RECIPE.requirements = {
	...
	RECIPE = cwRecipes.recipes:New("wanderer_jerkin");
		RECIPE.name = "Wanderer Jerkin";
		RECIPE.requiredBeliefs = {"craftsman"};
		RECIPE.requiredBeliefsNiceNames = {"Craftsman"};
		RECIPE.excludedFactions = {"Goreic Warrior"};
		RECIPE.requirements = {
	...
	RECIPE = cwRecipes.recipes:New("wanderer_coat_of_plates");
		RECIPE.name = "Wanderer Coat of Plates";
		RECIPE.requiresSmithy = true;
		RECIPE.requiredBeliefs = {"artisan"};
		RECIPE.requiredBeliefsNiceNames = {"Artisan"};
		RECIPE.excludedFactions = {"Goreic Warrior"};
		...
		RECIPE.result = {
			["wanderer_coat_of_plates"] = {amount = 1},
		};
		RECIPE.category = "Armor"
		RECIPE.finishSound = "generic_ui/smelt_success_02.wav";
		RECIPE.failSound = "buttons/button2.wav"
	...
	RECIPE = cwRecipes.recipes:New("empty_vial");
	RECIPE.name = "(5x) Empty Vial";
	RECIPE.requiresSmithy = true;
	RECIPE.requiredBeliefs = {"smith"};
	...
	RECIPE = cwRecipes.recipes:New("vial_of_liquid_steel");
	RECIPE.name = "(2x) Vial of Liquid Steel";
	RECIPE.requiresSmithy = true;
	RECIPE.requiredBeliefs = {"blacksmith"};
	...
	RECIPE = cwRecipes.recipes:New("vial_of_liquid_fine_steel");
	RECIPE.name = "(2x) Vial of Liquid Fine Steel";
	RECIPE.requiresSmithy = true;
	RECIPE.requiredBeliefs = {"master_blacksmith"};
	...
	RECIPE.result = {
		["vial_of_liquid_fine_steel"] = {amount = 2},
	};
	RECIPE.category = "Other"
	RECIPE.finishSound = "ambient/fire/mtov_flame2.wav";
	RECIPE.failSound = "buttons/button2.wav"
	...
	RECIPE = cwRecipes.recipes:New("vial_of_liquid_gold");
	RECIPE.name = "(2x) Vial of Liquid Gold";
	RECIPE.requiresSmithy = true;
	RECIPE.requiredBeliefs = {"blacksmith"};
	RECIPE.requiredBeliefsNiceNames = {"Blacksmith"};
	RECIPE.requirements = {
	...
	RECIPE = cwRecipes.recipes:New("vial_of_liquid_shagalaxian_steel");
	RECIPE.name = "(2x) Vial of Liquid Shagalaxian Steel";
	RECIPE.requiresSmithy = true;
	RECIPE.requiredBeliefs = {"enduring_is_the_bear"};
	...
	RECIPE.result = {
		["vial_of_liquid_shagalaxian_steel"] = {amount = 2},
	};
	RECIPE.category = "Other"
	RECIPE.finishSound = "ambient/fire/mtov_flame2.wav";
	RECIPE.failSound = "buttons/button2.wav"
	...
	RECIPE = cwRecipes.recipes:New("vial_of_liquid_maximilian_steel");
	RECIPE.name = "(2x) Vial of Liquid Maximilian Steel";
	RECIPE.requiresSmithy = true;
	...
	RECIPE.result = {
		["vial_of_liquid_maximilian_steel"] = {amount = 2},
	};
	RECIPE.category = "Other"
	RECIPE.finishSound = "ambient/fire/mtov_flame2.wav";
	RECIPE.failSound = "buttons/button2.wav"
	...
	-- emplacements keep the fuck out of here for deployables too buzzwords --

	RECIPE = cwRecipes.recipes:New("can_shot");
	RECIPE.name = "Canister Shot";
	RECIPE.requiresHeatSource = true;
	RECIPE.requiredBeliefs = {"artisan"};
	RECIPE.requiredBeliefsNiceNames = {"Artisan"};
	RECIPE.excludedSubfactions = {"Clan Gore", "Clan Harald", "Clan Reaver", "Clan Crast", "Clan Grock"};
	...
	RECIPE = cwRecipes.recipes:New("cannon_ball");
	RECIPE.name = "Cannon Ball";
	RECIPE.requiresHeatSource = true;
	RECIPE.requiredBeliefs = {"artisan"};
	RECIPE.requiredBeliefsNiceNames = {"Artisan"};
	RECIPE.excludedSubfactions = {"Clan Gore", "Clan Harald", "Clan Reaver", "Clan Crast", "Clan Grock"};
	...
	RECIPE = cwRecipes.recipes:New("explosive_ball");
	RECIPE.name = "Explosive Cannon Ball";
	RECIPE.requiresHeatSource = true;
	RECIPE.requiredBeliefs = {"artisan"};
	RECIPE.requiredBeliefsNiceNames = {"Artisan"};
	RECIPE.excludedSubfactions = {"Clan Gore", "Clan Harald", "Clan Reaver", "Clan Crast", "Clan Grock"};
	...
	RECIPE = cwRecipes.recipes:New("gunpowder_packing");
	RECIPE.name = "Gunpowder Packing";
	RECIPE.requiresHeatSource = true;
	RECIPE.requiredBeliefs = {"artisan"};
	RECIPE.requiredBeliefsNiceNames = {"Artisan"};
	RECIPE.excludedSubfactions = {"Clan Gore", "Clan Harald", "Clan Reaver", "Clan Crast", "Clan Grock"};
	...
	RECIPE = cwRecipes.recipes:New("deployable_cannon");
		RECIPE.name = "Cannon";
		RECIPE.requiredBeliefs = {"artisan"};
		RECIPE.requiredBeliefsNiceNames = {"Artisan"};
		RECIPE.excludedSubfactions = {"Clan Gore", "Clan Harald", "Clan Reaver", "Clan Crast", "Clan Grock"};
	...
	RECIPE = cwRecipes.recipes:New("deployable_ballista");
		RECIPE.name = "Ballista";
		RECIPE.requiredBeliefs = {"smith"};
		RECIPE.requiredBeliefsNiceNames = {"Smith"};
		RECIPE.requirements = {
			["steel_ingot"] = {amount = 1},
	...
	RECIPE = cwRecipes.recipes:New("begotten_javelin_ballistabolt");
		RECIPE.name = "Ballista Bolt";
		RECIPE.requiredBeliefs = {"smith"};
		RECIPE.requiredBeliefsNiceNames = {"Smith"};
		RECIPE.requirements = {
			["steel_ingot"] = {amount = 1},
		...
		RECIPE.result = {
			["begotten_javelin_ballistabolt"] = {amount = 1},
		};
		RECIPE.category = "Munitions"
		RECIPE.finishSound = "generic_ui/wood_01.wav";
		RECIPE.failSound = "buttons/button2.wav"
