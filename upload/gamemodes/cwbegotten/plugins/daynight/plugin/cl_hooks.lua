...
function cwDayNight:Think()
	if Clockwork.Client:HasInitialized() then
		...
		if cycle == "night" and (Clockwork.Client:GetZone() == "wasteland" or Clockwork.Client:GetZone() == "bridge") and not Clockwork.player:IsNoClipping(Clockwork.Client) and not Clockwork.Client.dueling then
