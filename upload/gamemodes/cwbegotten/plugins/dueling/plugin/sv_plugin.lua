...
local bMap = game.GetMap() == "rp_begotten3" or game.GetMap() == "rp_begotten_redux" or game.GetMap() == "rp_scraptown" or game.GetMap() == "rp_district21" or game.GetMap() == "bg_prelude" ;
...
util.AddNetworkString("cwRenderMode");

function cwDueling:SetPlayerRenderMode(player, renderMode)
	player:SetRenderMode(renderMode);

	net.Start("cwRenderMode");
		net.WriteEntity(player);
		net.WriteUInt(renderMode, 4);
	net.Broadcast();
