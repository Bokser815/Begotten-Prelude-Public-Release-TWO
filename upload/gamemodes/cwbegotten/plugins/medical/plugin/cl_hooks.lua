...
function cwMedicalSystem:DrawTargetPlayerSymptoms(target, alpha, x, y)
	...
	for i = 1, #symptoms do
		...
		elseif symptom == "Shackled" then
			if symptomText then
				symptomText = symptomText.." They have slave shackles around their ankles.";
			else
				symptomText = "They have slave shackles around their ankles.";
			end
		end
	end
