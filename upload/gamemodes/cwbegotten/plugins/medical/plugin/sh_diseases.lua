...
-- Prelude symptons are: Cramps, Laughter

local DISEASE = {};
	DISEASE.uniqueID = "common_cold";
	DISEASE.name = "Common Cold";
	DISEASE.rarity = 80; -- Chance from 1 to 100 of the disease being considered an option, usually further modified by other chances.
	...
	DISEASE.stages = {
		...
		[2] = {progressionTime = 1800, symptoms = {"Fatigue", "Headaches"}},
		[3] = {progressionTime = 1800, symptoms = {"Fatigue", "Headaches", "Coughing"}},
		[4] = {progressionTime = 1800, symptoms = {"Fatigue", "Headaches", "Coughing", "Paleness"}},
	};
...
local DISEASE = {};
	...
	DISEASE.stages = {
		[1] = {progressionTime = 1800, symptoms = nil,},
		[2] = {progressionTime = 1800, symptoms = {"Nausea"}},
		[3] = {progressionTime = 2400, symptoms = {"Nausea", "Coughing", "Paleness"}},
		[4] = {progressionTime = 1800, symptoms = {"Nausea", "Coughing", "Paleness", "Vomiting"}},
	};
cwMedicalSystem:RegisterDisease(DISEASE.uniqueID, DISEASE);
...
--	DISEASE.fromWater = true;
	DISEASE.stages = {
		...
		[2] = {progressionTime = 1800, symptoms = {"Fatigue", "Headaches", "Coughing", "Vomiting"}},
		[3] = {progressionTime = 900, symptoms = {"Fatigue", "Headaches", "Nausea", "Coughing", "Vomiting Blood", "Pustules"}},
		[4] = {progressionTime = 900, symptoms = {"Fatigue", "Headaches", "Nausea", "Coughing", "Vomiting Blood", "Pustules", "Rage"}},
	};
...
local DISEASE = {};
	DISEASE.uniqueID = "food_poisoning"; -- currently uncurable, maybe alchemy can have miracle cures
	DISEASE.name = "Food Poisoning";
	DISEASE.deathChance = 1; -- Chance of death when final stage is reached. Otherwise they will recover.
	DISEASE.contagious = false;
	DISEASE.inPerishables = true;
	DISEASE.fromWater = true;
	DISEASE.stages = {
		[1] = {progressionTime = 600, symptoms = nil,},
		[2] = {progressionTime = 600, symptoms = {"Fatigue", "Cramps"}},
		[3] = {progressionTime = 600, symptoms = {"Fatigue", "Cramps", "Vomiting"}},
		[4] = {progressionTime = 600, symptoms = {"Fatigue", "Cramps", "Vomiting", "Paleness"}},
	};
cwMedicalSystem:RegisterDisease(DISEASE.uniqueID, DISEASE);

local DISEASE = {};
	DISEASE.uniqueID = "kuru"; -- currently uncurable, maybe alchemy can have miracle cures
	DISEASE.name = "Kuru";
	DISEASE.permanent = true;
	DISEASE.contagious = false;
	DISEASE.rarity = 2;
	DISEASE.inPerishables = false;
	DISEASE.fromWater = true;
	DISEASE.stages = {
		[1] = {symptoms = {"Nausea", "Headaches", "Laughter"}}, -- giggles
	};
cwMedicalSystem:RegisterDisease(DISEASE.uniqueID, DISEASE);

local DISEASE = {};
	DISEASE.uniqueID = "shackled";
	DISEASE.name = "Shackled";
	DISEASE.permanent = false;
	DISEASE.contagious = false;
	DISEASE.stages = {
		[1] = {symptoms = {"Shackled"}},
	};
...
local DISEASE = {};
	DISEASE.uniqueID = "brain_bleeding";
	DISEASE.name = "Brain Bleeding";
	DISEASE.deathChance = 75; -- Chance of death when final stage is reached. Otherwise they will recover.
	DISEASE.contagious = false;
	DISEASE.inPerishables = false;
	DISEASE.fromWater = false;
	DISEASE.stages = {
		[1] = {progressionTime = 60, symptoms = nil,},
		[2] = {progressionTime = 120, symptoms = {"Fatigue", "Headaches"}},
		[3] = {progressionTime = 300, symptoms = {"Fatigue", "Headaches", "Nausea"}},
		[4] = {progressionTime = 600, symptoms = {"Fatigue", "Headaches", "Vomiting", "Nausea"}},
	};
cwMedicalSystem:RegisterDisease(DISEASE.uniqueID, DISEASE);