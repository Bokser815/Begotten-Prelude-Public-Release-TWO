...
local map = game.GetMap() == "rp_begotten3" or game.GetMap() == "rp_begotten_redux" or game.GetMap() == "rp_scraptown" or game.GetMap() == "rp_district21" or game.GetMap() == "bg_prelude" ;
...
cwMusic.AmbientMusicTable = {
	...
	["Darklander Temple Ambience"] = { -- ambient music for the darklander temple
		{name = "Turjan Aylahn - Onirya (Highfleet OST)", track = "fiend/onirya.mp3", length = 228, volume = 0.75},
		{name = "Tomb of the Ancients - Homeworld Deserts Of Kharak", track = "fiend/ancienttomb.mp3", length = 135, volume = 0.75},
		{name = "Beautiful Nights - Homeworld Deserts Of Kharak", track = "fiend/desertnights.mp3", length = 122, volume = 0.75},
	},
	--[[["Insanity Ambience"] = {
...
function cwMusic:GetAmbientMusicCategory()
	...
	if game.GetMap() == "rp_district21" and Clockwork.ConVars.AMBIENTMUSICCLASSIC:GetInt() ~= 1 then
		...
		if zone == "wasteland" or zone == "ashland" and cwDayNight and cwDayNight.currentCycle == "night" then
		...
		elseif zone == "sandland" then
			trackType = "Darklander Temple Ambience";
		elseif zone == "gore" or zone == "gore_hallway" or zone == "gore_tree" then
			trackType = "Gore Forest Ambience";
		end
	end
