...
local sanitySubSafezones = {
	...
	["bg_prelude"] = {
		["wasteland"] = {
			{pos1 = Vector(12276.055664, -10979.509766, 4460.760742), pos2 = Vector(15881.810547, -12738.801758, 5289.243652)}, -- Voltcave
			{pos1 = Vector(-12119.24609375, -13463.7734375, 4253.03125), pos2 = Vector(-12119.24609375, -13463.7734375, 4253.03125)}, -- Castle
		},
	},
	["rp_district21"] = {
		["wasteland"] = {
...
function cwSanity:PlayerThink(player, curTime, infoTable, alive, initialized, plyTab)
	...
	if (!plyTab.nextSanityDecay or plyTab.nextSanityDecay <= curTime) then
		...
		if (map != "rp_begotten3" and map != "rp_district21" and map != "bg_prelude") then
