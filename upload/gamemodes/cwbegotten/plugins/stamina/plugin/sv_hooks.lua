		...
		if initialized and alive then
			...
			if plyTab.banners then
				...
				for k, v in pairs(plyTab.banners) do
					if v == "glazic" then
						if playerFaction == "Gatekeeper" or playerFaction == "Holy Hierarchy" or playerFaction == "Hillkeeper" or playerFaction == "Pope Adyssa's Gatekeepers" or playerFaction == "Order of Eternal Penance"  then
							regeneration = 4.5;
