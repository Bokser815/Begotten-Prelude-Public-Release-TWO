...
function cwStamina:GetMaxStaminaPlugin(player)
	if player:GetCharacterData("isDemon", false) then
		...
		elseif subfaction == "Legionary" or player:GetFaction() == "Pope Adyssa's Gatekeepers" or subfaction == "Varazdat" or subfaction == "Philimaxio" or player:GetFaction() == "Order of Eternal Penance"  then
