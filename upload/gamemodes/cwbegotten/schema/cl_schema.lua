...
function Schema:CheapleCutscene()
	...
	if Clockwork.Client:Alive() and (game.GetMap() == "rp_begotten3" or game.GetMap() == "rp_district21" or game.GetMap() == "bg_prelude") then
...
netstream.Hook("SoundSignalFrq", function(data)
	Derma_StringRequest("Sound Signaling", "What number would you like to input?", data, function(text)
		Clockwork.kernel:RunCommand("SetSignalFrq", text);
