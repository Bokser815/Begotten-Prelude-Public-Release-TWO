...
function PANEL:Paint(w, h)
	...
	local newsizew, newsizeH = Clockwork.kernel:GetCachedTextSize(bigTextFont, "You are missing part of or all of the Begotten Prelude content!");

	draw.SimpleText("You are missing part of or all of the Begotten Prelude content!", bigTextFont, (w * 0.5) - (newsizew / 2), h * 0.4, colRed)
