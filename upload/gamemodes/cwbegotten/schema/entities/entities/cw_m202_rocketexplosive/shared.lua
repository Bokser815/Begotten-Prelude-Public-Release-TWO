...
self.Entity:SetMaterial("metal2a")
 ...
 function ENT:Think()
	...
	local tr = util.TraceLine( trace )
		...
		if tr.Hit then
			...
			self:EmitSound("prelude/warofrightscannon/SW_Mortar_Close_Impact01.ogg", 140, 100)
			self:EmitSound("prelude/warofrightscannon/explo_artillery_01__blast_002_544234739.ogg", 140, 100)
				local effectdata = EffectData()
					...
					util.BlastDamage(self.Entity, self:OwnerGet(), tr.HitPos, 600, 200)
