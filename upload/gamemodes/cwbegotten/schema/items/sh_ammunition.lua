...
local ITEM = Clockwork.item:New("shot_base");
	ITEM.name = "Smelt Stick";
	ITEM.model = "models/props_lab/box01a.mdl";
	ITEM.weight = 0.2;
	ITEM.stackable = true;
	ITEM.description = "A box containing a smelt stick. It can be used to weld metal together in a blowtorch.";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/box01a.png"
	
	
	ITEM.ammoType = "SmeltStick";
	ITEM.ammoName = "SmeltStick";
	ITEM.requiredReloadBelief = "mechanic";
