...
ITEM.components = {breakdownType = "breakdown", items = {"scrap", "scrap", "scrap", "scrap", "scrap", "cloth"}, scrapperItems = {"scrap", "scrap", "scrap", "cloth"}};
...
ITEM.components = {breakdownType = "breakdown", items = {"scrap", "scrap", "scrap", "scrap", "scrap", "scrap", "scrap", "scrap"}, scrapperItems = {"scrap", "scrap", "scrap", "scrap", "scrap", "scrap", "scrap"}};
...
ITEM.components = {breakdownType = "breakdown", items = {"leather", "leather", "scrap", "scrap", "scrap", "steel_chunks", "steel_chunks"}, scrapperItems = {"leather", "leather", "scrap", "scrap", "steel_chunks", "steel_chunks"}};
ITEM.itemSpawnerInfo = {category = "Armor", rarity = 1000, supercrateOnly = true};
...
ITEM.components = {breakdownType = "meltdown", items = {"scrap", "scrap", "scrap", "scrap", "scrap", "scrap", "scrap"},  scrapperItems = {"scrap", "scrap", "scrap", "scrap", "scrap"}};
...
ITEM.components = {breakdownType = "meltdown", items = {"tech", "tech", "scrap", "scrap", "scrap", "scrap", "scrap"}, scrapperItems = {"tech", "tech", "scrap", "scrap", "scrap"}};
...
local ITEM = Clockwork.item:New("clothes_base");
ITEM.name = "Rebel Gatekeeper Plate";
ITEM.group = "gatekeepers/gatekeeperaux_black";
...
ITEM.weight = 5;
ITEM.weightclass = "Medium";
ITEM.description = "A set of studded plate armor used by some gatekeeper legion.";
ITEM.useSound = "armormovement/body-armor-b4.WAV.mp3";
ITEM.excludeFactions = {"Goreic Warrior"};
ITEM.faction = "Gatekeeper";
