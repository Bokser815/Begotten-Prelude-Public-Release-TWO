...
local ITEM = Clockwork.item:New("enchanted_base");
	ITEM.name = "Bandolier of a Powderboy";
	ITEM.model = "models/begotten_prelude/items/ncr_bandolier.mdl";
	ITEM.weight = 1;
	ITEM.uniqueID = "bandolier";
	ITEM.description = "A powder covered khaki and leather bandolier. It's last owner had a penchant for poppery, it seems.";
	ITEM.iconoverride = "materials/begottenprelude/ui/itemicons/ncr_bandolier.png";
	ITEM.charmEffects = "- Increases reload speed by 15%.";
	
	ITEM.itemSpawnerInfo = {category = "Charms", rarity = 1250};
ITEM:Register();

local ITEM = Clockwork.item:New("enchanted_base");
	ITEM.name = "Skull of a Pig";
	ITEM.model = "models/weapons/w_defuser.mdl";
	ITEM.weight = 0.5;
	ITEM.uniqueID = "skull_pig";
	ITEM.description = "The grotesque skull of a pig, likely belonged to a bloated Immortal or just someone's leftovers.";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/"..ITEM.uniqueID..".png";
	ITEM.charmEffects = "- Increases all faith gain by 25% if you are of the Faith of the Many.";
	ITEM.requiredFaiths = {"Faith of the Many"};
	ITEM.kinisgerOverride = true;
...
local ITEM = Clockwork.item:New("enchanted_base");
	ITEM.name = "Rose Colored Gloves";
	ITEM.model = "models/mosi/fallout4/props/weapons/melee/boxingglove.mdl";
	ITEM.weight = 0.2;
	ITEM.uniqueID = "rose_gloves";
	ITEM.description = "Old but sturdy rose tinted gloves that look like a perfect fit for you!";
	ITEM.charmEffects = "- Increases crop harvest yield";
