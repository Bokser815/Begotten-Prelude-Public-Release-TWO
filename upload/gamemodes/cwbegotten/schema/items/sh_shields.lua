...
local ITEM = Clockwork.item:New("shield_base");
	...
	ITEM.components = {breakdownType = "breakdown", items = {"scrap", "scrap", "scrap", "scrap"}, scrapperItems = {{"scrap", "scrap"}}};
...
local ITEM = Clockwork.item:New("shield_base");
	ITEM.name = "Darklander Shield";
	ITEM.model = "models/begotten_prelude/shields/griffin.mdl";
	ITEM.weight = 4;
	ITEM.uniqueID = "shielddarklander";
	ITEM.description = "A shield of crude steel painted with the blazon of a gryphon. It is said that the crimson velvet draws its hue from the blood of the forgeslaves crafting these shields.";
	ITEM.iconoverride = "materials/begottenprelude/ui/itemicons/griffin.png"
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_Spine2";
	ITEM.attachmentOffsetAngles = Angle(98.45, 0, 176.02);
	ITEM.attachmentOffsetVector = Vector(0, 2.2, 0);
	
	ITEM.components = {breakdownType = "meltdown", items = {"steel_chunks", "steel_chunks", "leather", "wood"}};
ITEM:Register();

local ITEM = Clockwork.item:New("shield_base");
	ITEM.name = "Immortal Shield";
	ITEM.model = "models/burningchicken/darksouls3_weapons/normal_shields/porcine_shield.mdl";
	ITEM.weight = 10;
	ITEM.uniqueID = "shieldpork";
	ITEM.description = "A big porky shield.";
	--ITEM.iconoverride = "materials/begotten/ui/itemicons/knights_shield.png"
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_Spine2";
	ITEM.attachmentOffsetAngles = Angle(90.5, 201.88, 269.5);
	ITEM.attachmentOffsetVector = Vector(0, 0.462094, 0);
	ITEM.bulletConditionScale = 0.1;
	
	ITEM.components = {breakdownType = "meltdown", items = {"fine_steel_chunks", "fine_steel_chunks"}};
	ITEM.requiredbeliefs = {"defender"};
	ITEM.attributes = {"unbreakable"};
	ITEM.requireFaith = {"Faith of the Dark", "Faith of the Many"};

ITEM:Register();

local ITEM = Clockwork.item:New("shield_base");
	ITEM.name = "Rebel Gatekeeper Shield";
	ITEM.model = "models/burningchicken/darksouls3_weapons/normal_shields/wargod_wooden_shield.mdl";
	ITEM.weight = 5;
	ITEM.uniqueID = "shieldrebel";
	ITEM.description = "A shoddy looking tower shield bearing iconography of the Glaze.";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/gatekeeper_shield.png"
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_Spine2";
	ITEM.attachmentOffsetAngles = Angle(90, 0, 0);
	...
	ITEM.components = {breakdownType = "meltdown", items = {"steel_chunks", "wood", "wood"}};
ITEM:Register();
