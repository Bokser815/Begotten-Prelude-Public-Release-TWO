...
ITEM = Clockwork.item:New("weapon_base");
	ITEM.name = "Grockling Stone Greatsword";
	ITEM.model = "models/demonssouls/weapons/dragon_bone_smasher.mdl";
	ITEM.weight = 8;
	ITEM.uniqueID = "begotten_2h_great_grocklingsword";
	ITEM.category = "Melee";
	ITEM.description = "An impossibly fused collection of rare and powerful pieces of the earth, it embodies the raw beauty and wild spirit of the northern wilderness.";
	ITEM.iconoverride = "materials/begotten/ui/weaponicons/dragon_bone_smasher.png"
	ITEM.meleeWeapon = true;
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_Spine2";
	ITEM.attachmentOffsetAngles = Angle(91.13, 175.33, 0);
	ITEM.attachmentOffsetVector = Vector(0.88, 1.14, 27.89);
	
	ITEM.components = {breakdownType = "breakdown", items = {"stone", "stone", "stone", "stone", "stone", "stone", "stone"}};
	ITEM.requiredbeliefs = {"strength"};
	ITEM.requireFaith = {"Old Ways"};
	ITEM.excludeSubfactions = {"Clan Thrym", "Clan Harald", "Clan Gore", "Clan Shagalax", "Clan Crast"};
ITEM:Register();
...
local ITEM = Clockwork.item:New("weapon_base");
	...
	ITEM.components = {breakdownType = "breakdown", items = {"scrap", "scrap", "scrap", "scrap"}, scrapperItems = {"scrap", "scrap"}}; -- use "breakdown" for other type
	ITEM.requiredbeliefs = {"strength"};
ITEM:Register();
...
local ITEM = Clockwork.item:New("weapon_base");
	...
	ITEM.components = {breakdownType = "breakdown", items = {"iron_chunks", "scrap", "scrap", "scrap", "tech", "tech"}, scrapperItems = {"iron_chunks", "scrap", "scrap", "scrap", "tech"}}; -- use "breakdown" for other type
...
local ITEM = Clockwork.item:New("weapon_base");
	ITEM.name = "Stop Sign";
	ITEM.model = "models/stophere.mdl";
	ITEM.weight = 6;
	ITEM.uniqueID = "begotten_2h_great_gorecleaver";
	ITEM.category = "Melee";
	ITEM.description = "A full-on traffic sign. Stop here.";
	--ITEM.iconoverride = "materials/begotten/ui/itemicons/gore_cleaver.png"
	ITEM.meleeWeapon = true;
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_Spine2";
...
local ITEM = Clockwork.item:New("weapon_base");
	ITEM.name = "Kanabo";
	ITEM.model = "models/begotten/weapons/kanabo.mdl";
	ITEM.weight = 4;
	ITEM.uniqueID = "begotten_prelude_2h_great_kanabo";
	ITEM.category = "Melee";
	ITEM.description = "A carved wooden haft with rounded nails holding metal braces. It is an eastern design that is heavy, yet manuverable.";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/bgpweap/kanabo.png"
	ITEM.meleeWeapon = true;
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_Spine2";
...
local ITEM = Clockwork.item:New("weapon_base");
	ITEM.name = "Scrap Hacker";
	ITEM.model = "models/begotten/weapons/scrappersword.mdl";
	ITEM.weight = 4;
	ITEM.uniqueID = "begotten_prelude_2h_great_scraphacker";
	ITEM.category = "Melee";
	ITEM.description = "A truly mighty sword made from cut metal beams and girders. Users of blades like these are uncommon in Scrapper culture, as being able to lift and use one effectively is a sign of exceptional strength.";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/bgpweap/scrappersword.png"
	ITEM.meleeWeapon = true;
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_Spine2";
	ITEM.attachmentOffsetAngles = Angle(90, 0, 190.94);
	ITEM.attachmentOffsetVector = Vector(2.12, 3, 16.39);
...
local ITEM = Clockwork.item:New("weapon_base");
	ITEM.name = "Dane Axe";
	ITEM.model = "models/weapons/daneaxe/daneaxe.mdl";
	ITEM.weight = 4;
	ITEM.uniqueID = "begotten_prelude_2h_great_daneaxe";
	ITEM.category = "Melee";
	ITEM.description = "DESC";
	--ITEM.iconoverride = "materials/begotten/ui/itemicons/war_club.png"
	ITEM.meleeWeapon = true;
...
local ITEM = Clockwork.item:New("weapon_base");
	ITEM.name = "Heavy Cleaver";
	ITEM.model = "models/begotten/weapons/bill.mdl";
	ITEM.weight = 4;
	ITEM.uniqueID = "begotten_prelude_2h_great_heavycleaver";
	ITEM.category = "Melee";
	ITEM.description = "DESC";
	--ITEM.iconoverride = "materials/begotten/ui/itemicons/war_club.png"
	ITEM.meleeWeapon = true;
...
local ITEM = Clockwork.item:New("weapon_base");
	...
	ITEM.weight = 4;
	ITEM.uniqueID = "begotten_prelude_2h_great_bludgeoner";
	ITEM.category = "Melee";
	ITEM.description = "DESC";
	--ITEM.iconoverride = "materials/begotten/ui/itemicons/war_club.png"
	ITEM.meleeWeapon = true;
...
local ITEM = Clockwork.item:New("weapon_base");
	ITEM.name = "Sign of Doom";
	ITEM.model = "models/slop/signofdoom.mdl";
	ITEM.weight = 4;
	ITEM.uniqueID = "begotten_prelude_2h_great_signofdoom";
	ITEM.category = "Melee";
	ITEM.description = "A chopper made of discarded road signs welded onto stamped metal brackets, with a melted rebar grip. It's a sign... A sign of DOOM!";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/bgpweap/signofdoom.png"
	ITEM.meleeWeapon = true;
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_Spine2";
