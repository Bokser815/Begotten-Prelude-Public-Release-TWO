...
local ITEM = Clockwork.item:New("weapon_base");
	...
	ITEM.components = {breakdownType = "breakdown", items = {"scrap", "wood", "wood"}, scrapperItems = {"scrap", "wood"}};
ITEM:Register();
...
local ITEM = Clockwork.item:New("weapon_base");
	ITEM.name = "Scrap Frag-Axe";
	ITEM.model = "models/begotten/weapons/fragaxe.mdl";
	ITEM.weight = 1.5;
	ITEM.uniqueID = "begotten_prelude_1h_scrapfragaxe";
	ITEM.category = "Melee";
	ITEM.description = "An array of axe heads held together with screws and bolts. This weapon presents a scrap equation with only one answer: Corpsing.";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/bgpweap/fragaxe.png"
	ITEM.meleeWeapon = true;
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_L_Thigh";
	ITEM.attachmentOffsetAngles = Angle(20.88, 180, 180);
	ITEM.attachmentOffsetVector = Vector(3.54, 1.41, 1.87);
	ITEM.canUseOffhand = true;
	ITEM.canUseShields = true;
...
local ITEM = Clockwork.item:New("weapon_base");
	...
	ITEM.components = {breakdownType = "meltdown", items = {"scrap", "scrap", "scrap", "scrap", "tech", "tech"}, scrapperItems = {"scrap", "scrap", "scrap", "tech"}};
	ITEM.requiredbeliefs = {"wriggle_fucking_eel"};
ITEM:Register();
...
local ITEM = Clockwork.item:New("weapon_base");
	...
	ITEM.components = {breakdownType = "breakdown", items = {"scrap", "scrap", "scrap"}, scrapperItems = {"scrap", "scrap"}};
	ITEM.itemSpawnerInfo = {category = "Melee", rarity = 900, bNoSupercrate = true};
ITEM:Register();

local ITEM = Clockwork.item:New("weapon_base");
	ITEM.name = "Scrapper Chainsword";
	ITEM.model = "models/begoyten/weprobs/chainsword/chainsword.mdl";
	ITEM.weight = 2;
	ITEM.iconoverride = "materials/begotten/ui/itemicons/bgpweap/chainsword.png"
	ITEM.uniqueID = "begotten_1h_scrapperchainsword";
	ITEM.category = "Melee";
	ITEM.description = "A true marvel of Scrapper engineering, doubtlessly a weapon capable of utter corpsing. It features an ergonomic scrapped grip with a trigger to REV IT UP!!!";
	ITEM.meleeWeapon = true;
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_L_Thigh";
	ITEM.attachmentOffsetAngles = Angle(0, 5, 220);
	ITEM.attachmentOffsetVector = Vector(4, 2, 0.63);
...
local ITEM = Clockwork.item:New("weapon_base");
	...
	ITEM.model = "models/bf1/weapons/meat cleaver.mdl";	
	ITEM.weight = 0.6;
	ITEM.uniqueID = "begotten_prelude_1h_meatcleaver";
	ITEM.category = "Melee";
	ITEM.description = "A large butcher's knife with a rectangular blade. Ideal for cutting meat, live or raw.";
	--ITEM.iconoverride = "materials/begotten/ui/itemicons/warhammer.png"
	ITEM.meleeWeapon = true;
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_L_Thigh";
...
local ITEM = Clockwork.item:New("weapon_base");
	...
	ITEM.weight = 0.6;
	ITEM.bodygroup1 = 2;
	ITEM.uniqueID = "begotten_prelude_1h_polehook";
	ITEM.category = "Melee";
	ITEM.description = "A wooden rod with a multi-pronged hook fixed at the top.";
	--ITEM.iconoverride = "materials/begotten/ui/itemicons/warhammer.png"
	ITEM.meleeWeapon = true;
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_L_Thigh";
	ITEM.attachmentOffsetAngles = Angle(269.68, 133.21, 187.96);
	ITEM.attachmentOffsetVector = Vector(4.16, -9.7, 16.17);
	ITEM.canUseOffhand = true;
	ITEM.canUseShields = true;
...
local ITEM = Clockwork.item:New("weapon_base");
	ITEM.name = "Sailor Hook";
	ITEM.model = "models/bf1/weapons/marine hook.mdl";	
	ITEM.weight = 1;
	ITEM.uniqueID = "begotten_prelude_1h_sailorhook";
	ITEM.category = "Melee";
	ITEM.description = "A metal hook utilized by Glazic sailors long ago.";
	--ITEM.iconoverride = "materials/begotten/ui/itemicons/warhammer.png"
	ITEM.meleeWeapon = true;
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_L_Thigh";
...
local ITEM = Clockwork.item:New("weapon_base");
	ITEM.name = "Sickle";
	ITEM.model = "models/bf1/weapons/sickle.mdl";	
	ITEM.weight = 0.8;
	ITEM.uniqueID = "begotten_prelude_1h_sickle";
	ITEM.category = "Melee";
	ITEM.description = "A serf's tool affixed with a curved blade. Once used for reaping crops, it now reaps corpses.";
	--ITEM.iconoverride = "materials/begotten/ui/itemicons/warhammer.png"
	ITEM.meleeWeapon = true;
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_L_Thigh";
	...
	ITEM.itemSpawnerInfo = {category = "Melee", rarity = 110};
ITEM:Register();
...
local ITEM = Clockwork.item:New("weapon_base");
	...
	ITEM.weight = 1;
	ITEM.uniqueID = "begotten_prelude_1h_wrench";
	ITEM.category = "Melee";
	ITEM.description = "A rusty, old wrench used for pipe fittings. Despite the practicality, it doesn't fit the pipes within the Scrap Factory.";
	--ITEM.iconoverride = "materials/begotten/ui/itemicons/warhammer.png"
	ITEM.meleeWeapon = true;
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_L_Thigh";
...
local ITEM = Clockwork.item:New("weapon_base");
	...
	--ITEM.skin = 0;
	ITEM.bodygroup1 = 7;
	ITEM.uniqueID = "begotten_prelude_1h_hookwrench";
	ITEM.category = "Melee";
	ITEM.description = "A wrench with two large metal hooks tied to the end of it. You can fix someone's innards with it.";
	--ITEM.iconoverride = "materials/begotten/ui/itemicons/warhammer.png"
	ITEM.meleeWeapon = true;
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_L_Thigh";
	...
	ITEM.components = {breakdownType = "meltdown", items = {"steel_chunks", "scrap"}};
	--ITEM.itemSpawnerInfo = {category = "Melee", rarity = 400};
ITEM:Register();
-- Hill shit
