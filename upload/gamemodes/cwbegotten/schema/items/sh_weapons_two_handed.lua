...
local ITEM = Clockwork.item:New("weapon_base");
	...
	ITEM.weight = 3.5;
	ITEM.uniqueID = "begotten_prelude_2h_meathook";
	ITEM.category = "Melee";
	ITEM.description = "A large meat hook designed to hang meat. Either an animal or human would fit perfectly on this.";
	--ITEM.iconoverride = "materials/begotten/ui/itemicons/sledge.png"
	ITEM.meleeWeapon = true;
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_Spine2";
	...
	ITEM.components = {breakdownType = "breakdown", items = {"iron_chunks", "iron_chunks"}};
	ITEM.itemSpawnerInfo = {category = "Melee", rarity = 375, bNoSupercrate = true};
ITEM:Register();
...
local ITEM = Clockwork.item:New("weapon_base");
	...
	ITEM.weight = 4.5;
	ITEM.bodygroup1 = 7;
	ITEM.uniqueID = "begotten_prelude_2h_maul";
	ITEM.category = "Melee";
	ITEM.description = "A massive stone maul ideal for crushing rocks or bones.";
	--ITEM.iconoverride = "materials/begotten/ui/itemicons/sledge.png"
	ITEM.meleeWeapon = true;
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_Spine2";
	...
	ITEM.components = {breakdownType = "breakdown", items = {"stone", "iron_chunks", "stone"}};
	--ITEM.itemSpawnerInfo = {category = "Melee", rarity = 375, bNoSupercrate = true};
ITEM:Register();

local ITEM = Clockwork.item:New("weapon_base");
	ITEM.name = "Estoc";
	ITEM.model = "models/begotten/weapons/estoc.mdl";
	ITEM.weight = 2.5;
	ITEM.uniqueID = "begotten_prelude_2h_estoc";
	ITEM.category = "Melee";
	ITEM.description = "A deft duelist longsword meant for nobility. A thinner blade and steeper edge make thrusts swift and deadly.";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/bgpweap/estoc.png"
	ITEM.meleeWeapon = true;
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_Spine2";
	ITEM.attachmentOffsetAngles = Angle(92.49, 183.98, 10.94);
...
local ITEM = Clockwork.item:New("weapon_base");
	...
	ITEM.model = "models/begotten/weapons/executionersword.mdl";
	ITEM.weight = 2.5;
	ITEM.uniqueID = "begotten_prelude_2h_exesword";
	ITEM.category = "Melee";
	ITEM.description = "In the past, Glazic Ministers ordered executions with these unwieldy yet incredibly sharp blades. Although still in service, they are slowly being phased-out in favor of the dreaded Well.";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/bgpweap/executionersword.png"
	ITEM.meleeWeapon = true;
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_Spine2";
	ITEM.attachmentOffsetAngles = Angle(92.49, 183.98, 10.94);
...
local ITEM = Clockwork.item:New("weapon_base");
	ITEM.name = "Long Falchion";
	ITEM.model = "models/weapons/chopper/chopper.mdl";
	ITEM.weight = 2.5;
	ITEM.uniqueID = "begotten_prelude_2h_scrapchopper";
	ITEM.category = "Melee";
	ITEM.description = "A reproduction of an ancient weapon, said to be used by the first Glazic footsoldiers. A venerated sight on the battlefield.";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/bgpweap/chopper.png"
	ITEM.meleeWeapon = true;
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_Spine2";
	ITEM.attachmentOffsetAngles = Angle(92.49, 183.98, 10.94);
...
local ITEM = Clockwork.item:New("weapon_base");
	ITEM.name = "Tipped Staff";
	ITEM.model = "models/weapons/tippedstaff/tippedstaff.mdl";
	ITEM.weight = 2.5;
	ITEM.uniqueID = "begotten_prelude_2h_tippedstaff";
	ITEM.category = "Melee";
	ITEM.description = "A quarterstaff with spiked metal caps mounted to both ends. Though still nimble, the caps allow the staff to shatter skull and bone with minimal effort.";
	ITEM.iconoverride = "materials/begotten/ui/itemicons/bgpweap/tippedstaff.png"
	ITEM.meleeWeapon = true;
	ITEM.isAttachment = true;
	ITEM.attachmentBone = "ValveBiped.Bip01_Spine2";
	ITEM.attachmentOffsetAngles = Angle(92.49, 183.98, 10.94);
