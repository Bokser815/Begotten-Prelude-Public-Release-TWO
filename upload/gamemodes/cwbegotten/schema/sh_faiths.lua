...
local MANY = Schema.faiths:New("many")
	MANY.name = "Faith of the Many";
	MANY.color = Color(137, 100, 0);
	MANY.subfaiths = {"The Libertines", "The Sows", "The Vultures"};
	
	-- for character creation
	MANY.description = "The Faith of the Many is FILLER TEXT FILLER TEXT";
	MANY.image = "begotten/ui/bgtbtnfaithmany.png";
Schema.faiths:Register(MANY)
