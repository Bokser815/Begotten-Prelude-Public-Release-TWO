...
-- This will be in the header until Bokser unfucks his way of pushing changes
...
Clockwork.flag:Add("l", "Speak Languages", "Player can speak all languages.")
...
RANDOM_FORENAMES = {
	...
	["darklandic"] = {
		["male"] = {"Abbas", "Abdallah", "Abdel", "Abdoulaye", "Abdul", "Abdullah", "Abdulrahman", "Abidemi", "Ade", "Adil", "Ahmad", "Ahmed", "Akbar", "Ali", "Amin", "Amir", "Anwar", "Aqeel", "Asad", "Ayman", "Babacar", "Bakary", "Bilal", "Dauda", "Fahad", "Faisal", "Farid", "Farouk", "Ghassan", "Hadi", "Hakim", "Hamidou", "Harouna", "Hassan", "Hussein", "Ibrahim", "Ilyas", "Imran", "Ismael", "Jamal", "Jibril", "Khalil", "Mamadou", "Mansour", "Mohammed", "Musa", "Nasir", "Nizar", "Omar", "Rashid", "Saidou", "Sidi", "Tahir", "Tariq", "Yahya", "Youssef", "Zakariya", "Ziyad"},
		["female"] = {"Aisha", "Amara", "Amina", "Aya", "Ayisha", "Aziza", "Bibi", "Binta", "Dalia", "Dalila", "Dunia", "Fadila", "Fanta", "Fatima", "Fauzia", "Ghada", "Habiba", "Halima", "Hana", "Hanan", "Hasna", "Hawa", "Inaya", "Jamila", "Jihan", "Kadija", "Kalila", "Karima", "Khadija", "Khayrat", "Layla", "Lina", "Mahin", "Maha", "Maimouna", "Malaika", "Malika", "Marwa", "Maryam", "Muna", "Nadia", "Najah", "Naima", "Nasira", "Nawal", "Nour", "Rabia", "Rahma", "Rania", "Rasha", "Rokia", "Sabah", "Salma", "Sana", "Sara", "Shadia", "Zahra", "Zainab"}
	},
}

RANDOM_SURNAMES = {
	["glazic"] = {"Abriallias", "Aelius", "Anderson", "Antonius", "Appius", "Arcadius", "Armstrong", "Armistead", "Aetius", "Aurelius", "Bateman", "Barclay", "Brutus", "Buchanan", "Caecilius", "Carrinas", "Cassius", "Clemens", "Cornelius", "Chamberlain", "Cranston", "Crassus", "Crawford", "Decimius", "Dilworth", "Domitius", "Fabius", "Flavius", "Franklin", "Fulvius", "Galerius", "Hamilton", "Harris", "Harvus", "Honorius", "Horatius", "Julius", "Jupiter", "Koulius", "Krammy", "Labienus", "Lincoln", "Marius", "Morgan", "Morris", "Nasennius", "Oswald", "Opimius", "Patrobius", "Parker", "Petronius", "Philadelphus", "Pompeius", "Quinctius", "Randolph", "Roberts", "Rufinius", "Septimius", "Severus", "Simmons", "Sheridan", "Stevens", "Stuart", "Sullivan", "Suetonius", "Taylor", "Temple", "Thompson", "Titus", "Tullius", "Tyler", "Valerius", "Vorenus", "Wales", "Wilkes"},
	...
	["gore-glazic"] = {"Leveson", "Frilleck", "Stokes", "Holbrook", "Sayth", "Arderne", "Bewley", "Bost", "Blount", "Kent", "Makepiece", "Lichefield", "Wenmann", "Hertcombe", "Wilkins", "Carrinas", "Daggas", "Thomisson", "Pursglove", "Coultherst", "Battyl", "Henshawe", "Wything", "Brennyng", "Peltie", "Socksson", "Stokton", "Boltone", "Hamme", "Ledleye", "Maxwells", "Haytere", "Cocke", "Harlande", "Blakeslee", "Calidwalle", "Esburne", "Oldwood", "Helmwood", "Krammy", "Haige", "Hathiwey", "Raclyffe", "Deadmane", "Greymane", "Battleborn", "Gladwyne", "Hurst", "Aston", "Glaziere", "Parrywy", "Rayne", "Chestere", "Colee", "Ackerg", "Stune", "Westcotte", "Reever", "Arte", "Rey", "Stidolphe", "Blackburn", "Washennon", "Willough", "Townsend", "Kardene", "Blakisle", "Ekklesonne", "Wiccam", "Rode", "Kyrstone", "Bourke", "Heile", "Wilkiee", "Sawvers", "Albyne", "Fitsgeffrey", "Pennebrygg", "Morecote", "Fox", "Tegonwell", "Baldwin", "Bedgbery", "Sedrigg", "Swan", "Bridgeman"},
	["darklandic"] = {"Abadi", "Abbasi", "Abdullah", "Abdulrahman", "Abubakar", "Ahmadi", "Alavi", "Alhassan", "Ali", "Amiri", "Ardalan", "Asghar", "Aslami", "Awwal", "Azimi", "Bashir", "Chouhan", "Dawood", "Ehsani", "Etemadi", "Fadlallah", "Farsi", "Farzaneh", "Ghani", "Hakimi", "Hassan", "Hussein", "Ibrahim", "Isa", "Jafari", "Kabir", "Kamara", "Kamari", "Kanu", "Karambe", "Karami", "Khatib", "Mansoor", "Masoudi", "Mazari", "Mehrdad", "Mohammed", "Nadir", "Najjar", "Ouattara", "Qadir", "Rashidi", "Raza", "Sadiq", "Shahidi"},
}
...
elseif (game.GetMap() == "bg_prelude") then
	Schema.MapLocations = {
		["hell"] = Vector(6649.989746, 3399.206055, -7333.455566),
		["bridge"] = Vector(12885.070312, -3365.234131, -9312.910156),
		["seastyx"] = Vector(-9648, 10077, -14631),
		["seacalm"] = Vector(533, 10451, -14747),
		["searough"] = Vector(10436, 9826, -14708),
		["tech"] = Vector(5481.266113, -2650.118408, -146.710709),
		["ashlands"] = Vector(5481.266113, -2650.118408, -146.710709),
		["oil"] = Vector(10338.480469, 10290.250977, -487.292969),
		["scrapper"] = Vector(-10411.344727, 11220.963867, -174.969894),
		["antenna"] = Vector(10504.727539, -12082.660156, -18.124008),
		["ash"] = Vector(-2294.611084, -12177.483398, -480.524414),
		["gorewatch"] = Vector(10623.127930, 11300.962891, 4900.216309),
		["arch"] = Vector(10660.035156, -13647.782227, 4811.573242),
		["voltcave"] = Vector(14882.217773, -11953.310547, 4779.195312),
		["scrapfactory"] = Vector(741.302246, -11753.941406, 5380.684082),
		["castle"] = Vector(-11734.887695, -12910.735352, 4425.258789),
		["pillars"] = Vector(-8632.337891, -1773.862061, 4260.758789),
		["city"] = Vector(426.831482, -2481.371094, 4160.209961),
		["tower"] = Vector(1224.251099, 11565.387695, 4771.521484),
		["darklander"] = Vector(6661,-12606,-13294),
	}
