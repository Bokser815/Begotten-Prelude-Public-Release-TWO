...
if map == "bg_prelude" then
	...
	local TOWER = zones:New("tower", "suprawasteland")
		...
		TOWER.bounds = {
			min = Vector(3511, 11715, 4339),
			max = Vector(-1566, 19003, 6470),
		};
	TOWER:Register()
	...
	local THEATER = zones:New("theater")
		...
		THEATER.bounds = {
			min = Vector(1735.693848, 14566.909180, 6125.77148),
			max = Vector(2367.309570, 13784.215820, 6321.974609),
		};
		THEATER.priority = 2;
	THEATER:Register()

	local BRIDGE = zones:New("bridge", "suprawasteland")
		BRIDGE.hasNight = true;
		BRIDGE.name = "Bridge";
		BRIDGE.map = "bg_prelude";
		BRIDGE.fogColors = {r = 96, g = 47, b = 0};
		BRIDGE.fogColorsNight = {r = 32, g = 12, b = 4};
		BRIDGE.fogStart = 256;
		BRIDGE.fogStartNight = 256;
		BRIDGE.fogEnd = 936;
		BRIDGE.fogEndNight = 936;
		BRIDGE.colorModify = {["$pp_colour_brightness"] = -0.03, ["$pp_colour_contrast"] = 1.15, ["$pp_colour_colour"] = 0.85};
		BRIDGE.colorModifyNight = {["$pp_colour_brightness"] = -0.1, ["$pp_colour_contrast"] = 0.9, ["$pp_colour_colour"] = 0.75};
		BRIDGE.skyFix = {r = 32, g = 21, b = 1}
		BRIDGE.skyFixNight = {r = 15, g = 5, b = 1}
		BRIDGE.hasWeather = true;
		BRIDGE.bounds = {
			min = Vector(14870, -5378, -10840),
			max = Vector(10815, 540, -8791),
		};
		
		-- Called every frame.
		function BRIDGE:RenderCallback()
			DrawBloom(0.1, 1.4, 5, 5, 0.1, 0.5, 1, 0.8, 0.8);
		end;
	BRIDGE:Register()
	...
	local TOOTHBOY = zones:New("toothboy")
		...
		TOOTHBOY.bounds = {
			min = Vector(13794, -14032, 4117),
			max = Vector(13406.818359, -10287.144531, 4477.854492),
		};
	TOOTHBOY:Register()
	...
	local DUEL = zones:New("duel")
		...
		DUEL.bounds = {
			min = Vector(3046.204834, -8002.397949, -11000.442383),
			max = Vector(7059, -5964, -9673),
		};
	DUEL:Register()

	local SCRAPFACTORY = zones:New("scrapper")
		SCRAPFACTORY.name = "Scrap Factory";
		SCRAPFACTORY.map = "bg_prelude";
		SCRAPFACTORY.fogColors = {r = 0, g = 0, b = 0};
		SCRAPFACTORY.fogStart = 0;
		SCRAPFACTORY.fogEnd = 2048;
		SCRAPFACTORY.colorModify = {["$pp_colour_brightness"] = -0.05, ["$pp_colour_contrast"] = 1.5, ["$pp_colour_colour"] = 1.5, ["$pp_colour_mulr"] = 1.5};
		SCRAPFACTORY.skyFix = {r = 0, g = 0, b = 0}
		SCRAPFACTORY.bounds = {
			min = Vector(-3193.671143, -11210.808594, 3293.884033),
			max = Vector(1228.715942, -12233.997070, 5064.848633),
		};
	SCRAPFACTORY:Register()

	local CAVES = zones:New("caves")
		CAVES.name = "Caves";
		CAVES.map = "bg_prelude";
		...
		CAVES.bounds = {
			min = Vector(8366, 9177, 3021),
			max = Vector(-4929, -6838, 3550),
		};
	CAVES:Register()

	local ASHLAND = zones:New("ashland", "supraashland")
		ASHLAND.name = "Ashlands";
		ASHLAND.map = "bg_prelude";
		ASHLAND.hasNight = true;
		ASHLAND.fogColors = {r = 53, g = 53, b = 27};
		ASHLAND.fogColorsNight = {r = 2, g = 4, b = 2};
		ASHLAND.fogStart = 64;
		ASHLAND.fogEnd = 1624
		ASHLAND.fogStartNight = 64;
		ASHLAND.fogEndNight = 1024;
		ASHLAND.colorModify = {["$pp_colour_brightness"] = 0, ["$pp_colour_contrast"] = 1, ["$pp_colour_colour"] = 1};
		ASHLAND.colorModify = {["$pp_colour_brightness"] = -0.03, ["$pp_colour_contrast"] = 1.15, ["$pp_colour_colour"] = 0.85};
		ASHLAND.colorModifyNight = {["$pp_colour_brightness"] = -0.1, ["$pp_colour_contrast"] = 0.9, ["$pp_colour_colour"] = 0.75};
		ASHLAND.skyFixNight = {r = 11, g = 11, b = 7}
		ASHLAND.skyFix = {r = 22, g = 22, b = 13}
		ASHLAND.bounds = {
			min = Vector(15681,18364,-2845),
			max = Vector(-17424,-15741,1280),
		};
		ASHLAND.colorInterval = 64
		ASHLAND.distanceInterval = 2048
		ASHLAND.intervalMult = true;
		ASHLAND.hasWeather = true;
		-- Called every frame.
		function ASHLAND:RenderCallback()
			DrawBloom(0.9, 1.4, 5, 5, 0.1, 0.5, 1, 1, 1);
			DrawMaterialOverlay("begotten/effects/grain_overlay", 1);
		end;
	ASHLAND:Register()
	--[[
	local GORE = zones:New("gore", "supragore")
		...
		GORE.map = "bg_prelude";
		GORE.fogColors = {r = 45, g = 56, b = 46};
        GORE.fogStart = 0;
        GORE.fogEnd = 2024;
        GORE.colorModify = {["$pp_colour_brightness"] = 0, ["$pp_colour_contrast"] = 1.1, ["$pp_colour_colour"] = 1.1};
        GORE.skyFix = {r = 23, g = 29, b = 23}
		GORE.bounds = {
			min = Vector(-6626, -2192, -5446),
			max = Vector(12879.901367, -15234.935547, -3069.451660),
		};
	...
	local GORE_TREE = zones:New("gore_tree", "supragore")
		...
		GORE_TREE.bounds = {
			min = Vector(-15190, 12720, -5954),
			max = Vector(-3448, 480, -2198),
		};
	...
	local HELL = zones:New("hell")
		...
		HELL.bounds = {
			min = Vector(3578,416,-8465),
			max = Vector(15045,12660,-3413),
		};
		HELL.ForceCallback = true;
		HELL.ForceFog = true;
		HELL.hasWeather = true;
		-- Called every frame.
	...
	local SANDLAND = zones:New("sandland")
		SANDLAND.name = "Sand Land";
		SANDLAND.map = "bg_prelude";
		SANDLAND.fogColors = {r = 210, g = 180, b = 140};
		SANDLAND.fogStart = 0;
		SANDLAND.fogEnd = 2900;
		SANDLAND.colorModify = {["$pp_colour_brightness"] = -0.2, ["$pp_colour_contrast"] = 1, ["$pp_colour_colour"] = 1}
		SANDLAND.skyFix = {r = 210, g = 180, b = 140}
		SANDLAND.bounds = {
			min = Vector(10215,-10885,-14841),
			max = Vector(5334,-15566,-11335),
		};
		SANDLAND.ForceCallback = true;
		SANDLAND.ForceFog = true;
		SANDLAND.hasWeather = false;
		-- Called every frame.
		function SANDLAND:RenderCallback()
			--DrawBloom(0.05, 0.8, 1, 1, 0.1, 0.5, 5, 1, 1);
		end;
	SANDLAND:Register()
	
	local BASEMENT = zones:New("basement")
		BASEMENT.name = "Basement";
		BASEMENT.map = "bg_prelude";
		BASEMENT.fogColors = {r = 10, g = 10, b = 10};
		BASEMENT.fogStart = 0;
		BASEMENT.fogEnd = 768;
		BASEMENT.colorModify = {["$pp_colour_brightness"] = -0.2, ["$pp_colour_contrast"] = 1, ["$pp_colour_colour"] = 0.2}
		BASEMENT.skyFix = {r = 30, g = 30, b = 30}
		BASEMENT.bounds = {
			min = Vector(976.96875, 7055.5751953125, -8956.1552734375),
    		max = Vector(-4184.8891601563, 11187.530273438, -7573.791015625),
		};
		BASEMENT.ForceCallback = true;
		BASEMENT.ForceFog = true;

		function BASEMENT:OnEnter()
			Clockwork.Client:EmitSound("begotten/slender.wav", 75, 80);
			Clockwork.Client:EmitSound("begotten/spawn/01_event_critters.mp3");
			Schema:SanityZoom(-0.1);
			Clockwork.Client:Disorient(3);

		end
		
		-- Called every frame.
		function BASEMENT:RenderCallback()
			DrawBloom(0.1, 1.4, 5, 5, 0.1, 0.5, 1, 0.8, 0.8);
		end;
	BASEMENT:Register()
	...
	local SEA1 = zones:New("sea_rough")
		...
		SEA1.bounds = {
			min = Vector(5400, 15286, -15210),
			max = Vector(15608, 5102, -12054),
		};
	...
	local SEA2 = zones:New("sea_calm")
		...
		SEA2.bounds = {
			min = Vector(5371, 5099, -15210),
			max = Vector(-4862, 1583, -12055),
		};
	...
	local SEA3 = zones:New("sea_styx")
		...
		SEA3.bounds = {
			min = Vector(-4890, 5100, -15210),
			max = Vector(-15094, 15283, -12055),
		};
