...
local DUELIST = Clockwork.trait:New()
	...
	DUELIST.excludedsubfactions = {"Auxiliary", "Clan Crast", "Scut"};
...
local FOLLOWED = Clockwork.trait:New()
	...
	FOLLOWED.points = -7
	FOLLOWED.excludedfactions = {"Gatekeeper", "Pope Adyssa's Gatekeepers", "Order of Eternal Penance"};
...
local GUNSLINGER = Clockwork.trait:New()
	...
	GUNSLINGER.excludedsubfactions = {"Clan Crast", "Clan Grock", "Clan Harald", "Clan Reaver", "Clan Gore", "Scut"};
...
local SURVIVALIST = Clockwork.trait:New()
	...
	SURVIVALIST.excludedsubfactions = {"Clan Crast", "Clan Grock", "Scut"};
...
local VETERAN = Clockwork.trait:New()
	...
	VETERAN.excludedsubfactions = {"Clan Crast", "Clan Grock", "Scut"};
...
local ALCOHOLIC = Clockwork.trait:New()
	ALCOHOLIC.uniqueID = "alcoholic"
	ALCOHOLIC.name = "Alcoholic"
	ALCOHOLIC.description = "Your character is a drunkard, relying on alcohol to function correctly. While you are not under the influence of alcohol, your sanity loss is heavily increased."
	ALCOHOLIC.points = -2
Clockwork.trait:Register(ALCOHOLIC)

local WANTED = Clockwork.trait:New()
	WANTED.uniqueID = "wanted"
	WANTED.name = "Wanted"
	WANTED.description = "Your character is wanted by the Holy Hierarchy for your heinous crimes you've done in your past life. You will be targeted by bounty hunters and other forces of the law."
	WANTED.points = -3
	WANTED.requiredfactions = {"Wanderer"}
	WANTED.disables = {"pilgrim"}
Clockwork.trait:Register(WANTED)

local DEAF = Clockwork.trait:New()
	DEAF.uniqueID = "deaf"
	DEAF.name = "Deaf"
	DEAF.description = "Your character has lost their hearing, whether from birth or from battle. This trait makes your character unable to hear properly - both messages and sound."
	DEAF.points = -4
	DEAF.excludedfactions = {"Children of Satan"}
Clockwork.trait:Register(DEAF)

local DWARF = Clockwork.trait:New()
	DWARF.uniqueID = "dwarf"
	DWARF.name = "Dwarf"
	DWARF.description = "Whether by blood or pure misfortune, your character's natural height is significantly lower than those of average stature. "
	DWARF.points = 2
	DWARF.excludedfactions = {"Goreic Warrior"}
Clockwork.trait:Register(DWARF)

local GIANT = Clockwork.trait:New()
	GIANT.uniqueID = "giant"
	GIANT.name = "Giant"
	GIANT.description = "Your character, through heritage or random chance, matured into an abnormally large adult. This trait increases the size of your character, meaning you are both a larger target and you may find it difficult to fit into small places. This trait also lowers your maximum stability by 25 points, and slightly increases the rate at which your hunger and thirst deplete."
	GIANT.points = -4
	GIANT.excludedfactions = {"Goreic Warrior"}
Clockwork.trait:Register(GIANT)